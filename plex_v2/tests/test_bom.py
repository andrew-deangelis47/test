...
class TestBOM:
    ...
    def setup_method(self) -> PlexClient:
    ...
    def test_create(self):
        client = PlexClient()
        with patch.object(client, 'create_resource', return_value=self.mock_bom_in) \
    ...
    def test_get(self):
        client = PlexClient()
        with patch.object(client, 'get_resource', return_value=self.mock_bom_in):
