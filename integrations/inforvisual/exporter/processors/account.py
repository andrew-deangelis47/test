...
class AccountProcessor:
    ...
    def process_account_info(cls, order: Order):
        ...
        customer_notes = None
        account_id = None
        contact_id: int = order.contact.id
        billing_info = order.billing_info if order.billing_info else None
        ...
        return business_name, erp_code, payment_terms, payment_terms_period, customer_notes, account_id, contact_id, billing_info
