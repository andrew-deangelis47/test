...
class BaseProcessor:
    ...
    # TODO -
    #  might be able to use Django's "with transaction.atomic()" for rollbacks, see autonumber.py in jobboss-python
    #  for an example
    do_rollback = False
    ...
    def _process(self, *args, **kwargs):
        ...
        raise ProcessNotImplementedError(f"_process() method not implemented on {self.__class__.__name__}")
