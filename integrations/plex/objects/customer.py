...
from plex.objects.base import BaseObject, CreateMixin, RetrieveMixin, UpdateMixin, SearchMixin
from fuzzywuzzy import fuzz, process


@attr.s(kw_only=True)
class Customer(BaseObject, CreateMixin, RetrieveMixin, UpdateMixin, SearchMixin):
...
class CustomerAddress(BaseObject, CreateMixin, RetrieveMixin, SearchMixin, UpdateMixin):
    code = attr.ib(validator=instance_of(str))
...
@attr.s(kw_only=True, repr=False)
class CustomerContacts(BaseObject, CreateMixin, RetrieveMixin, SearchMixin, UpdateMixin):
