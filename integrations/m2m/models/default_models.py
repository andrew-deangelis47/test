...
class Qtmast(AutoNumberMixin, TruncatedModel):
    ...
    fdaterecvd = models.DateTimeField()
    ...
    fjobname = models.CharField(max_length=65)
    ...
    frequestno = models.CharField(max_length=15)
    ...
    fclosmemo = models.TextField()  # This field type is a guess.
    fmstreet = models.TextField()  # This field type is a guess.
    fmusermemo = models.TextField()  # This field type is a guess.
    fsalumemo = models.TextField()  # This field type is a guess.
...
class Syaddr(AddressNumberMixin, TruncatedModel):
    ...
    contactnum = models.CharField(db_column='ContactNum', max_length=6)  # Field name made lowercase.
    createddate = models.DateTimeField(db_column='CreatedDate', auto_now=True)  # Field name made lowercase.
    modifieddate = models.DateTimeField(db_column='ModifiedDate', auto_now=True)  # Field name made lowercase.
...
class Invend(TruncatedModel):
    fpartno = models.CharField(max_length=25)
    fpartrev = models.CharField(max_length=3)
    fpriority = models.CharField(max_length=1)
    fvendno = models.CharField(max_length=6)
    fvconvfact = models.DecimalField(max_digits=13, decimal_places=9)
    fvlastpc = models.DecimalField(max_digits=17, decimal_places=5)
    fvlastpd = models.DateTimeField()
    fvlastpq = models.DecimalField(max_digits=15, decimal_places=5)
    fvleadtime = models.DecimalField(max_digits=7, decimal_places=1)
    fvmeasure = models.CharField(max_length=3)
    fvpartno = models.CharField(max_length=25)
    fvptdes = models.CharField(max_length=35)
    fclastpono = models.CharField(max_length=10)
    fcjrdict = models.CharField(max_length=10)
    timestamp_column = models.TextField(blank=True, null=True)  # This field type is a guess.
    identity_column = models.AutoField(unique=True, primary_key=True)
    fvcomment = models.TextField()
    fac = models.CharField(max_length=20)
    fcudrev = models.CharField(max_length=3)
    fvlastapno = models.CharField(max_length=20)
    fvlasttxnpc = models.DecimalField(max_digits=17, decimal_places=5)
    fvfactor = models.DecimalField(max_digits=22, decimal_places=10)
    fccurid = models.CharField(max_length=3)
    fmulticurr = models.BooleanField()
    createddate = models.DateTimeField(db_column='CreatedDate', blank=True, null=True)  # Field name made lowercase.
    modifieddate = models.DateTimeField(db_column='ModifiedDate', blank=True, null=True)  # Field name made lowercase.
...
class Inonhd(TruncatedModel):
    fpartno = models.CharField(max_length=25)
    fpartrev = models.CharField(max_length=3)
    fbinno = models.CharField(max_length=14)
    flocation = models.CharField(max_length=14)
    fexpdate = models.DateTimeField()
    flot = models.CharField(max_length=50)
    fonhand = models.DecimalField(max_digits=15, decimal_places=5)
    identity_column = models.AutoField(unique=True, primary_key=True)
    timestamp_column = models.TextField(blank=True, null=True)  # This field type is a guess.
    fac = models.CharField(max_length=20)
    fcudrev = models.CharField(max_length=3)
    ...
    class Meta:
        managed = IS_TEST
        db_table = 'inonhd'
        unique_together = (('fpartno', 'fpartrev', 'flocation', 'fbinno', 'flot', 'fac', 'fexpdate'),)
...
class Ingrpc(TruncatedModel):
    fgc_number = models.CharField(max_length=6)
    fgc_desc = models.CharField(max_length=65)
    fpc_desc = models.CharField(max_length=65)
    sc01 = models.DecimalField(max_digits=7, decimal_places=3)
    sc02 = models.DecimalField(max_digits=7, decimal_places=3)
    sc03 = models.DecimalField(max_digits=7, decimal_places=3)
    sc04 = models.DecimalField(max_digits=7, decimal_places=3)
    sc05 = models.DecimalField(max_digits=7, decimal_places=3)
    sc06 = models.DecimalField(max_digits=7, decimal_places=3)
    sc07 = models.DecimalField(max_digits=7, decimal_places=3)
    sc08 = models.DecimalField(max_digits=7, decimal_places=3)
    sc09 = models.DecimalField(max_digits=7, decimal_places=3)
    sc10 = models.DecimalField(max_digits=7, decimal_places=3)
    sc11 = models.DecimalField(max_digits=7, decimal_places=3)
    sc12 = models.DecimalField(max_digits=7, decimal_places=3)
    sc13 = models.DecimalField(max_digits=7, decimal_places=3)
    sc14 = models.DecimalField(max_digits=7, decimal_places=3)
    sc15 = models.DecimalField(max_digits=7, decimal_places=3)
    sc16 = models.DecimalField(max_digits=7, decimal_places=3)
    sc17 = models.DecimalField(max_digits=7, decimal_places=3)
    sc18 = models.DecimalField(max_digits=7, decimal_places=3)
    sc19 = models.DecimalField(max_digits=7, decimal_places=3)
    sc20 = models.DecimalField(max_digits=7, decimal_places=3)
    sc21 = models.DecimalField(max_digits=7, decimal_places=3)
    sc22 = models.DecimalField(max_digits=7, decimal_places=3)
    sc23 = models.DecimalField(max_digits=7, decimal_places=3)
    sc24 = models.DecimalField(max_digits=7, decimal_places=3)
    sc25 = models.DecimalField(max_digits=7, decimal_places=3)
    sc26 = models.DecimalField(max_digits=7, decimal_places=3)
    sc27 = models.DecimalField(max_digits=7, decimal_places=3)
    sc28 = models.DecimalField(max_digits=7, decimal_places=3)
    sc29 = models.DecimalField(max_digits=7, decimal_places=3)
    sc30 = models.DecimalField(max_digits=7, decimal_places=3)
    sc31 = models.DecimalField(max_digits=7, decimal_places=3)
    sc32 = models.DecimalField(max_digits=7, decimal_places=3)
    identity_column = models.AutoField(unique=True, primary_key=True)
    timestamp_column = models.TextField(blank=True, null=True)  # This field type is a guess.
    createddate = models.DateTimeField(db_column='CreatedDate', blank=True, null=True)  # Field name made lowercase.
    modifieddate = models.DateTimeField(db_column='ModifiedDate', blank=True, null=True)  # Field name made lowercase.
...
class Inprod(TruncatedModel):
    fpc_number = models.CharField(max_length=4)
    fcinvadj = models.CharField(max_length=25)
    fcogslab = models.CharField(max_length=25)
    fcogsmatl = models.CharField(max_length=25)
    fcogsothr = models.CharField(max_length=25)
    fcogsovhd = models.CharField(max_length=25)
    finvacc = models.CharField(max_length=25)
    flabacc = models.CharField(max_length=25)
    flabrvarac = models.CharField(max_length=25)
    fmatlacc = models.CharField(max_length=25)
    fmatlvarac = models.CharField(max_length=25)
    fothracc = models.CharField(max_length=25)
    fothrvarac = models.CharField(max_length=25)
    fovhdacc = models.CharField(max_length=25)
    fovhdvarac = models.CharField(max_length=25)
    fpc_desc = models.CharField(max_length=55)
    fpc_name = models.CharField(max_length=12)
    fpurcvarac = models.CharField(max_length=25)
    frevalacc = models.CharField(max_length=25)
    frevenue = models.CharField(max_length=25)
    fschecode = models.CharField(max_length=6)
    fschedtype = models.CharField(max_length=1)
    identity_column = models.AutoField(unique=True, primary_key=True)
    timestamp_column = models.TextField(blank=True, null=True)  # This field type is a guess.
    finvtrans = models.CharField(db_column='fInvTrans', max_length=25)  # Field name made lowercase.
    fac = models.CharField(max_length=20)
    fintracc = models.CharField(max_length=25)
    fcogscomms = models.CharField(max_length=25)
    fsalesret = models.CharField(max_length=25)
    createddate = models.DateTimeField(db_column='CreatedDate', blank=True, null=True)  # Field name made lowercase.
    modifieddate = models.DateTimeField(db_column='ModifiedDate', blank=True, null=True)  # Field name made lowercase.
