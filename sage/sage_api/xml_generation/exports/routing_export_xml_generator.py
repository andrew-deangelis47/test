...
class RoutingExportXmlGenerator:
    ...
    def generate_routing_creation_xml(self, i_file):
        req_xml = """"""
        ...
        req_xml += self._generate_input_xml_for_routing_creation(i_file)
    ...
    def _generate_input_xml_for_routing_creation(self, i_file: str):
        dictionary = {
            self.INPUT_XML_KEY_GRP1: {
                self.INPUT_XML_KEY_TEMPLATE_IMPORT: "ZROUT",
