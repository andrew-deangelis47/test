...
class Account(TruncatedModel):
    ...
    rollup_account = models.CharField(db_column='Rollup_Account', max_length=10, blank=True,
                                      null=True)  # Field name made lowercase.
    last_updated = models.DateTimeField(db_column='Last_Updated')  # Field name made lowercase.
    section_name = models.CharField(db_column='Section_Name', max_length=25, blank=True,
                                    null=True)  # Field name made lowercase.
...
class AdditionalCharge(TruncatedModel):
    additional_chargekey = models.AutoField(db_column='Additional_ChargeKey',
                                            primary_key=True)  # Field name made lowercase.
    additional_charge = models.IntegerField(db_column='Additional_Charge', unique=True, blank=True,
                                            null=True)  # Field name made lowercase.
    job = models.ForeignKey('Job', models.DO_NOTHING, db_column='Job', blank=True,
                            null=True)  # Field name made lowercase.
    sales_code = models.CharField(db_column='Sales_Code', max_length=15, blank=True,
                                  null=True)  # Field name made lowercase.
    ...
    description = models.CharField(db_column='Description', max_length=25, blank=True,
                                   null=True)  # Field name made lowercase.
    est_price = models.DecimalField(db_column='Est_Price', max_digits=19,
                                    decimal_places=4)  # Field name made lowercase.
    act_price = models.DecimalField(db_column='Act_Price', max_digits=19, decimal_places=4, blank=True,
                                    null=True)  # Field name made lowercase.
    ...
    note_text = models.TextField(db_column='Note_Text', blank=True,
                                 null=True)  # Field name made lowercase. This field type is a guess.
    last_updated = models.DateTimeField(db_column='Last_Updated')  # Field name made lowercase.
    tax_code = models.CharField(db_column='Tax_Code', max_length=15, blank=True,
                                null=True)  # Field name made lowercase.
...
class Address(AutoNumberMixin, TruncatedModel):
    ...
    customer = models.ForeignKey('Customer', models.DO_NOTHING, db_column='Customer', blank=True,
                                 null=True)  # Field name made lowercase.
    vendor = models.ForeignKey('Vendor', models.DO_NOTHING, db_column='Vendor', blank=True,
                               null=True)  # Field name made lowercase.
    ...
    ship_via = models.CharField(db_column='Ship_Via', max_length=15, blank=True,
                                null=True)  # Field name made lowercase.
    ship_to_id = models.CharField(db_column='Ship_To_ID', max_length=6, blank=True,
                                  null=True)  # Field name made lowercase.
    ...
    cell_phone = models.CharField(db_column='Cell_Phone', max_length=20, blank=True,
                                  null=True)  # Field name made lowercase.
...
class Addresscountry(TruncatedModel):
    objectid = models.CharField(db_column='ObjectID', primary_key=True, max_length=36)  # Field name made lowercase.
    countrycode = models.CharField(db_column='CountryCode', max_length=3, blank=True,
                                   null=True)  # Field name made lowercase.
    countryname = models.CharField(db_column='CountryName', max_length=100, blank=True,
                                   null=True)  # Field name made lowercase.
...
class Addressstate(TruncatedModel):
    objectid = models.CharField(db_column='ObjectID', primary_key=True, max_length=36)  # Field name made lowercase.
    countrycode = models.CharField(db_column='CountryCode', max_length=3, blank=True,
                                   null=True)  # Field name made lowercase.
    statecode = models.CharField(db_column='StateCode', max_length=3, blank=True,
                                 null=True)  # Field name made lowercase.
    statename = models.CharField(db_column='StateName', max_length=100, blank=True,
                                 null=True)  # Field name made lowercase.
    last_updated = models.DateTimeField(db_column='Last_Updated', blank=True, null=True)  # Field name made lowercase.
...
class Attachment(AutoNumberMixin, TruncatedModel):
    ...
    attachment = models.IntegerField(db_column='Attachment', unique=True, blank=True,
                                     null=True)  # Field name made lowercase.
    owner_type = models.CharField(db_column='Owner_Type', max_length=50, blank=True,
                                  null=True)  # Field name made lowercase.
    owner_id = models.CharField(db_column='Owner_ID', max_length=50, blank=True,
                                null=True)  # Field name made lowercase.
    attach_path = models.TextField(db_column='Attach_Path', blank=True,
                                   null=True)  # Field name made lowercase. This field type is a guess.
    description = models.CharField(db_column='Description', max_length=254, blank=True,
                                   null=True)  # Field name made lowercase.
...
class AutoNumber(TruncatedModel):
    ...
    last_nbr = models.CharField(db_column='Last_Nbr', max_length=10, blank=True,
                                null=True)  # Field name made lowercase.
    last_updated = models.DateTimeField(db_column='Last_Updated', blank=True, null=True)  # Field name made lowercase.
...
class BarStockCutoff(TruncatedModel):
    bar_stock_cutoffkey = models.AutoField(db_column='Bar_Stock_CutoffKey',
                                           primary_key=True)  # Field name made lowercase.
    bar_stock_cutoff = models.IntegerField(db_column='Bar_Stock_Cutoff', unique=True, blank=True,
                                           null=True)  # Field name made lowercase.
...
class BillOfJobs(TruncatedModel):
    parent_job = models.ForeignKey('Job', models.DO_NOTHING, db_column='Parent_Job',
                                   related_name='bill_child')  # Field name made lowercase.
    component_job = models.ForeignKey('Job', models.DO_NOTHING, db_column='Component_Job',
                                      related_name='bill_parent')  # Field name made lowercase.
    ...
    relationship_qty = models.IntegerField(db_column='Relationship_Qty', blank=True,
                                           null=True)  # Field name made lowercase.
    manual_link = models.BooleanField(db_column='Manual_Link')  # Field name made lowercase.
    last_updated = models.DateTimeField(db_column='Last_Updated')  # Field name made lowercase.
    root_job = models.CharField(db_column='Root_Job', max_length=10, blank=True,
                                null=True)  # Field name made lowercase.
    objectid = models.CharField(db_column='ObjectID', primary_key=True, max_length=36)  # Field name made lowercase.
    job_operation_oid = models.CharField(db_column='Job_Operation_OID', max_length=36, blank=True,
                                         null=True)  # Field name made lowercase.
    root_job_oid = models.CharField(db_column='Root_Job_OID', max_length=36, blank=True,
                                    null=True)  # Field name made lowercase.
    parent_job_oid = models.CharField(db_column='Parent_Job_OID', max_length=36, blank=True,
                                      null=True)  # Field name made lowercase.
    component_job_oid = models.CharField(db_column='Component_Job_OID', max_length=36, blank=True,
                                         null=True)  # Field name made lowercase.
...
class BillOfQuotes(TruncatedModel):
    """
    For whatever reason we need to set parent_quote to primary key for the repeat work importer to run
    In reality it is not a primary key - if you need to create Bills of Quote then you need to create a custom model
    for this and just remove the primary key from parent_quote. See roncelli-plastics repo for an example on how to make
    a custom model
    """
    parent_quote = models.ForeignKey('Quote', models.DO_NOTHING, db_column='Parent_Quote', related_name='bill_child', primary_key=True)  # Field name made lowercase.
    ...
    quote_operation = models.IntegerField(db_column='Quote_Operation', blank=True,
                                          null=True)  # Field name made lowercase.
    relationship_type = models.CharField(db_column='Relationship_Type', max_length=9)  # Field name made lowercase.
    relationship_qty = models.IntegerField(db_column='Relationship_Qty', blank=True,
                                           null=True)  # Field name made lowercase.
...
class ChangeHistory(models.Model):
    change_history = models.CharField(db_column='Change_History', primary_key=True, max_length=50)  # Field name made lowercase.
    change_owner = models.CharField(db_column='Change_Owner', max_length=50, blank=True, null=True)  # Field name made lowercase.
    requested_by = models.SmallIntegerField(db_column='Requested_By', blank=True, null=True)  # Field name made lowercase.
    change_type = models.SmallIntegerField(db_column='Change_Type', blank=True, null=True)  # Field name made lowercase.
    external_notif = models.BooleanField(db_column='External_Notif', blank=True, null=True)  # Field name made lowercase.
    internal_notif = models.BooleanField(db_column='Internal_Notif', blank=True, null=True)  # Field name made lowercase.
    shipdate_changed = models.BooleanField(db_column='ShipDate_Changed', blank=True, null=True)  # Field name made lowercase.
    proddate_changed = models.BooleanField(db_column='ProdDate_Changed', blank=True, null=True)  # Field name made lowercase.
    ...
    changed_by = models.CharField(db_column='Changed_By', max_length=10, blank=True, null=True)  # Field name made lowercase.
    change_date = models.DateTimeField(db_column='Change_Date', blank=True, null=True)  # Field name made lowercase.
    old_date = models.DateTimeField(db_column='Old_Date', blank=True, null=True)  # Field name made lowercase.
    new_date = models.DateTimeField(db_column='New_Date', blank=True, null=True)  # Field name made lowercase.
    old_number = models.FloatField(db_column='Old_Number', blank=True, null=True)  # Field name made lowercase.
    new_number = models.FloatField(db_column='New_Number', blank=True, null=True)  # Field name made lowercase.
    last_updated = models.DateTimeField(db_column='Last_Updated', blank=True, null=True)  # Field name made lowercase.
    old_text = models.CharField(db_column='Old_Text', max_length=50, blank=True, null=True)  # Field name made lowercase.
    new_text = models.CharField(db_column='New_Text', max_length=50, blank=True, null=True)  # Field name made lowercase.
...
class Contact(AutoNumberMixin, TruncatedModel):
    ...
    customer = models.CharField(db_column='Customer', max_length=10, blank=True,
                                null=True)  # Field name made lowercase.
    ...
    contact_name = models.CharField(db_column='Contact_Name', max_length=30, blank=True,
                                    null=True)  # Field name made lowercase.
    title = models.CharField(db_column='Title', max_length=20, blank=True, null=True)  # Field name made lowercase.
    phone = models.CharField(db_column='Phone', max_length=20, blank=True, null=True)  # Field name made lowercase.
    phone_ext = models.CharField(db_column='Phone_Ext', max_length=8, blank=True,
                                 null=True)  # Field name made lowercase.
    fax = models.CharField(db_column='Fax', max_length=20, blank=True, null=True)  # Field name made lowercase.
    email_address = models.CharField(db_column='Email_Address', max_length=255, blank=True,
                                     null=True)  # Field name made lowercase.
    last_updated = models.DateTimeField(db_column='Last_Updated')  # Field name made lowercase.
    cell_phone = models.CharField(db_column='Cell_Phone', max_length=20, blank=True,
                                  null=True)  # Field name made lowercase.
...
class Cost(TruncatedModel):
    ...
    budget_amt = models.DecimalField(db_column='Budget_Amt', max_digits=19, decimal_places=4, blank=True,
                                     null=True)  # Field name made lowercase.
    mtd_amt = models.DecimalField(db_column='MTD_Amt', max_digits=19, decimal_places=4, blank=True,
                                  null=True)  # Field name made lowercase.
    last_updated = models.DateTimeField(db_column='Last_Updated')  # Field name made lowercase.
    per_ending_amt_5x = models.DecimalField(db_column='Per_Ending_Amt_5x', max_digits=19, decimal_places=4, blank=True,
                                            null=True)  # Field name made lowercase.
...
class CurrencyDef(TruncatedModel):
    currency_defkey = models.AutoField(db_column='Currency_DefKey', primary_key=True)  # Field name made lowercase.
    currency_def = models.IntegerField(db_column='Currency_Def', unique=True, blank=True,
                                       null=True)  # Field name made lowercase.
    currency_name = models.CharField(db_column='Currency_Name', unique=True,
    ...
    dec_symbol = models.CharField(db_column='Dec_Symbol', max_length=1, blank=True,
                                  null=True)  # Field name made lowercase.
    thousand_separator = models.CharField(db_column='Thousand_Separator', max_length=1, blank=True,
                                          null=True)  # Field name made lowercase.
...
class CurrencyRate(TruncatedModel):
    currency_ratekey = models.AutoField(db_column='Currency_RateKey', primary_key=True)  # Field name made lowercase.
    currency_rate = models.IntegerField(db_column='Currency_Rate', unique=True, blank=True,
                                        null=True)  # Field name made lowercase.
...
class Customer(TruncatedModel):
    ...
    ship_lead_days = models.SmallIntegerField(db_column='Ship_Lead_Days', blank=True,
                                              null=True)  # Field name made lowercase.
    print_statement = models.BooleanField(db_column='Print_Statement')  # Field name made lowercase.
    credit_limit = models.DecimalField(db_column='Credit_Limit', max_digits=19, decimal_places=4, blank=True,
                                       null=True)  # Field name made lowercase.
    curr_balance = models.DecimalField(db_column='Curr_Balance', max_digits=19, decimal_places=4, blank=True,
                                       null=True)  # Field name made lowercase.
    customer_since = models.DateTimeField(db_column='Customer_Since', blank=True,
                                          null=True)  # Field name made lowercase.
    accept_bo = models.BooleanField(db_column='Accept_BO')  # Field name made lowercase.
    pricing_level = models.CharField(db_column='Pricing_Level', max_length=15, blank=True,
                                     null=True)  # Field name made lowercase.
...
class CustomerPart(TruncatedModel):
    customer_partkey = models.AutoField(db_column='Customer_PartKey', primary_key=True)  # Field name made lowercase.
    customer_part = models.IntegerField(db_column='Customer_Part', unique=True, blank=True,
                                        null=True)  # Field name made lowercase.
    customer = models.CharField(db_column='Customer', max_length=10, blank=True,
                                null=True)  # Field name made lowercase.
    ...
    description = models.CharField(db_column='Description', max_length=30, blank=True,
                                   null=True)  # Field name made lowercase.
    ext_description = models.TextField(db_column='Ext_Description', blank=True,
                                       null=True)  # Field name made lowercase. This field type is a guess.
    sell_price = models.FloatField(db_column='Sell_Price')  # Field name made lowercase.
    last_updated = models.DateTimeField(db_column='Last_Updated')  # Field name made lowercase.
    customer_type = models.CharField(db_column='Customer_Type', max_length=15, blank=True,
                                     null=True)  # Field name made lowercase.
...
class Delivery(AutoNumberMixin, TruncatedModel):
    ...
    delivery = models.IntegerField(db_column='Delivery', unique=True, blank=True,
                                   null=True)  # Field name made lowercase.
    ...
    invoice_line = models.CharField(db_column='Invoice_Line', max_length=50, blank=True,
                                    null=True)  # Field name made lowercase.
    crmemo_line = models.CharField(db_column='CrMemo_Line', max_length=50, blank=True,
                                   null=True)  # Field name made lowercase.
    so_detail = models.IntegerField(db_column='SO_Detail', blank=True, null=True)  # Field name made lowercase.
    requested_date = models.DateTimeField(db_column='Requested_Date', blank=True,
                                          null=True)  # Field name made lowercase.
    ...
    shipped_quantity = models.IntegerField(db_column='Shipped_Quantity', blank=True,
                                           null=True)  # Field name made lowercase.
    remaining_quantity = models.IntegerField(db_column='Remaining_Quantity', blank=True,
                                             null=True)  # Field name made lowercase.
    returned_quantity = models.IntegerField(db_column='Returned_Quantity', blank=True,
                                            null=True)  # Field name made lowercase.
    ncp_quantity = models.IntegerField(db_column='NCP_Quantity', blank=True, null=True)  # Field name made lowercase.
    return_document = models.CharField(db_column='Return_Document', max_length=15, blank=True,
                                       null=True)  # Field name made lowercase.
...
class Employee(TruncatedModel):
    employee = models.CharField(db_column='Employee', primary_key=True, max_length=6)  # Field name made lowercase.
    work_center = models.ForeignKey('WorkCenter', models.DO_NOTHING, db_column='Work_Center', blank=True,
                                    null=True)  # Field name made lowercase.
    address = models.IntegerField(db_column='Address', blank=True, null=True)  # Field name made lowercase.
    user_values = models.IntegerField(db_column='User_Values', blank=True, null=True)  # Field name made lowercase.
    first_name = models.CharField(db_column='First_Name', max_length=10, blank=True,
                                  null=True)  # Field name made lowercase.
    middle_initial = models.CharField(db_column='Middle_Initial', max_length=1, blank=True,
                                      null=True)  # Field name made lowercase.
    ...
    class_field = models.CharField(db_column='Class',
                                   max_length=1)  # Field name made lowercase. Field renamed because it was a Python reserved word.
    hourly_rate = models.DecimalField(db_column='Hourly_Rate', max_digits=19, decimal_places=4, blank=True,
                                      null=True)  # Field name made lowercase.
    ...
    department = models.CharField(db_column='Department', max_length=15, blank=True,
                                  null=True)  # Field name made lowercase.
    supervisor = models.CharField(db_column='Supervisor', max_length=6, blank=True,
                                  null=True)  # Field name made lowercase.
    default_tran_limit = models.SmallIntegerField(db_column='Default_Tran_Limit', blank=True,
                                                  null=True)  # Field name made lowercase.
    begin_tran_prompt = models.CharField(db_column='Begin_Tran_Prompt', max_length=15, blank=True,
                                         null=True)  # Field name made lowercase.
    repeat_tran_prompt = models.CharField(db_column='Repeat_Tran_Prompt', max_length=15, blank=True,
                                          null=True)  # Field name made lowercase.
...
class FiscalPeriod(TruncatedModel):
    fiscal_period = models.CharField(db_column='Fiscal_Period', primary_key=True,
    ...
    fiscal_year = models.CharField(db_column='Fiscal_Year', max_length=50, blank=True,
                                   null=True)  # Field name made lowercase.
...
class FiscalYear(TruncatedModel):
    fiscal_year = models.CharField(db_column='Fiscal_Year', primary_key=True,
                                   max_length=50)  # Field name made lowercase.
    name = models.CharField(db_column='Name', max_length=30, blank=True, null=True)  # Field name made lowercase.
...
class GlEntry(TruncatedModel):
    ...
    statement_date = models.DateTimeField(db_column='Statement_Date', blank=True,
                                          null=True)  # Field name made lowercase.
...
class GlobalPref(TruncatedModel):
    objectid = models.CharField(db_column='ObjectID', primary_key=True, max_length=36)  # Field name made lowercase.
...
class Holiday(TruncatedModel):
    holiday = models.CharField(db_column='Holiday', primary_key=True, max_length=50)  # Field name made lowercase.
    holidayname = models.CharField(db_column='HolidayName', max_length=20, blank=True,
                                   null=True)  # Field name made lowercase.
    shift = models.CharField(db_column='Shift', max_length=36, blank=True, null=True)  # Field name made lowercase.
...
class Identitylog(TruncatedModel):
    spid = models.IntegerField(db_column='Spid', blank=True, null=True)  # Field name made lowercase.
    tablename = models.CharField(db_column='TableName', max_length=20, blank=True,
                                 null=True)  # Field name made lowercase.
...
class InvoiceDetail(TruncatedModel):
    ...
    price_uofm = models.CharField(db_column='Price_UofM', max_length=4, blank=True,
                                  null=True)  # Field name made lowercase.
    amount = models.DecimalField(db_column='Amount', max_digits=19, decimal_places=4, blank=True,
                                 null=True)  # Field name made lowercase.
    sales_rep = models.CharField(db_column='Sales_Rep', max_length=8, blank=True,
                                 null=True)  # Field name made lowercase.
    commission_pct = models.FloatField(db_column='Commission_Pct', blank=True, null=True)  # Field name made lowercase.
    taxable = models.BooleanField(db_column='Taxable')  # Field name made lowercase.
    ...
    prepaid_amt = models.DecimalField(db_column='Prepaid_Amt', max_digits=19, decimal_places=4, blank=True,
                                      null=True)  # Field name made lowercase.
    prepaid_code = models.CharField(db_column='Prepaid_Code', max_length=15, blank=True,
                                    null=True)  # Field name made lowercase.
    reference = models.CharField(db_column='Reference', max_length=10, blank=True,
                                 null=True)  # Field name made lowercase.
    note_text = models.TextField(db_column='Note_Text', blank=True,
                                 null=True)  # Field name made lowercase. This field type is a guess.
    last_updated = models.DateTimeField(db_column='Last_Updated')  # Field name made lowercase.
    part_number = models.CharField(db_column='Part_Number', max_length=30, blank=True,
                                   null=True)  # Field name made lowercase.
    ext_description = models.TextField(db_column='Ext_Description', blank=True,
                                       null=True)  # Field name made lowercase. This field type is a guess.
    part_description = models.CharField(db_column='Part_Description', max_length=30, blank=True,
                                        null=True)  # Field name made lowercase.
    revision = models.CharField(db_column='Revision', max_length=10, blank=True,
                                null=True)  # Field name made lowercase.
    customer_po = models.CharField(db_column='Customer_PO', max_length=30, blank=True,
                                   null=True)  # Field name made lowercase.
    ...
    additional_charge = models.IntegerField(db_column='Additional_Charge', blank=True,
                                            null=True)  # Field name made lowercase.
    price_coefficient = models.FloatField(db_column='Price_Coefficient')  # Field name made lowercase.
    order_unit = models.CharField(db_column='Order_Unit', max_length=4, blank=True,
                                  null=True)  # Field name made lowercase.
    price_unit_conv = models.FloatField(db_column='Price_Unit_Conv', blank=True,
                                        null=True)  # Field name made lowercase.
    tax_code = models.CharField(db_column='Tax_Code', max_length=15, blank=True,
                                null=True)  # Field name made lowercase.
    prog_payment = models.NullBooleanField(db_column='Prog_Payment')  # Field name made lowercase.
    prepaid_tax_amount = models.DecimalField(db_column='Prepaid_Tax_Amount', max_digits=19, decimal_places=4,
...
class InvoiceHeader(AutoNumberMixin, TruncatedModel):
    ...
    ar_description = models.CharField(db_column='AR_Description', max_length=25, blank=True,
                                      null=True)  # Field name made lowercase.
    due_date = models.DateTimeField(db_column='Due_Date', blank=True, null=True)  # Field name made lowercase.
    orig_invoice_amt = models.DecimalField(db_column='Orig_Invoice_Amt', max_digits=19, decimal_places=4, blank=True,
                                           null=True)  # Field name made lowercase.
    open_invoice_amt = models.DecimalField(db_column='Open_Invoice_Amt', max_digits=19, decimal_places=4, blank=True,
                                           null=True)  # Field name made lowercase.
    open_invoice_amt_curr_per = models.DecimalField(db_column='Open_Invoice_Amt_Curr_Per', max_digits=19,
    ...
    status = models.CharField(db_column='Status', max_length=8)  # Field name made lowercase.
    period = models.CharField(db_column='Period', max_length=50, blank=True, null=True)  # Field name made lowercase.
    taxable_amt = models.DecimalField(db_column='Taxable_Amt', max_digits=19, decimal_places=4, blank=True,
                                      null=True)  # Field name made lowercase.
    sales_tax_rate1 = models.FloatField(db_column='Sales_Tax_Rate1', blank=True,
                                        null=True)  # Field name made lowercase.
    sales_tax_rate2 = models.FloatField(db_column='Sales_Tax_Rate2', blank=True,
                                        null=True)  # Field name made lowercase.
    sales_tax_rate3 = models.FloatField(db_column='Sales_Tax_Rate3', blank=True,
                                        null=True)  # Field name made lowercase.
    sales_tax_rate4 = models.FloatField(db_column='Sales_Tax_Rate4', blank=True,
                                        null=True)  # Field name made lowercase.
    currency_conv_rate = models.FloatField(db_column='Currency_Conv_Rate')  # Field name made lowercase.
    trade_currency = models.IntegerField(db_column='Trade_Currency', blank=True,
                                         null=True)  # Field name made lowercase.
    ...
    user_values = models.IntegerField(db_column='User_Values', blank=True, null=True)  # Field name made lowercase.
    invoiced_by = models.CharField(db_column='Invoiced_By', max_length=30, blank=True,
                                   null=True)  # Field name made lowercase.
    journal_entry = models.CharField(db_column='Journal_Entry', max_length=50, blank=True,
                                     null=True)  # Field name made lowercase.
...
class InvoiceReceipt(TruncatedModel):
    ...
    amount_applied = models.DecimalField(db_column='Amount_Applied', max_digits=19, decimal_places=4, blank=True,
                                         null=True)  # Field name made lowercase.
    last_updated = models.DateTimeField(db_column='Last_Updated')  # Field name made lowercase.
    invoice_receipt = models.CharField(db_column='Invoice_Receipt', primary_key=True,
                                       max_length=50)  # Field name made lowercase.
    application_type = models.SmallIntegerField(db_column='Application_Type', blank=True,
                                                null=True)  # Field name made lowercase.
...
class Job(AutoNumberMixin, TruncatedModel):
    auto_number_attrs = [AutoNumberColumn('job', 'Job')]

    job = models.CharField(db_column='Job', primary_key=True, max_length=30)  # Field name made lowercase.
    sales_rep = models.ForeignKey(Employee, models.DO_NOTHING, db_column='Sales_Rep', blank=True,
                                  null=True)  # Field name made lowercase.
    customer = models.ForeignKey(Customer, models.DO_NOTHING, db_column='Customer', blank=True,
                                 null=True)  # Field name made lowercase.
    ship_to = models.IntegerField(db_column='Ship_To', blank=True, null=True)  # Field name made lowercase.
    user_values = models.IntegerField(db_column='User_Values', blank=True, null=True)  # Field name made lowercase.
    quote = models.CharField(db_column='Quote', max_length=30, blank=True, null=True)  # Field name made lowercase.
    contact = models.IntegerField(db_column='Contact', blank=True, null=True)  # Field name made lowercase.
    ship_via = models.CharField(db_column='Ship_Via', max_length=15, blank=True,
                                null=True)  # Field name made lowercase.
    terms = models.CharField(db_column='Terms', max_length=15, blank=True, null=True)  # Field name made lowercase.
    ...
    sales_code = models.CharField(db_column='Sales_Code', max_length=15, blank=True,
                                  null=True)  # Field name made lowercase.
    top_lvl_job = models.CharField(db_column='Top_Lvl_Job', max_length=10, blank=True,
                                   null=True)  # Field name made lowercase.
    ...
    extra_quantity = models.IntegerField(db_column='Extra_Quantity', blank=True,
                                         null=True)  # Field name made lowercase.
    ...
    split_quantity = models.IntegerField(db_column='Split_Quantity', blank=True,
                                         null=True)  # Field name made lowercase.
    completed_quantity = models.IntegerField(db_column='Completed_Quantity', blank=True,
                                             null=True)  # Field name made lowercase.
    shipped_quantity = models.IntegerField(db_column='Shipped_Quantity', blank=True,
                                           null=True)  # Field name made lowercase.
    fg_transfer_qty = models.IntegerField(db_column='FG_Transfer_Qty', blank=True,
                                          null=True)  # Field name made lowercase.
    returned_quantity = models.IntegerField(db_column='Returned_Quantity', blank=True,
                                            null=True)  # Field name made lowercase.
    in_production_quantity = models.IntegerField(db_column='In_Production_Quantity')  # Field name made lowercase.
    assembly_level = models.SmallIntegerField(db_column='Assembly_Level', blank=True,
                                              null=True)  # Field name made lowercase.
    ...
    open_operations = models.SmallIntegerField(db_column='Open_Operations', blank=True,
                                               null=True)  # Field name made lowercase.
    ...
    est_labor = models.DecimalField(db_column='Est_Labor', max_digits=19, decimal_places=4, blank=True,
                                    null=True)  # Field name made lowercase.
    est_material = models.DecimalField(db_column='Est_Material', max_digits=19, decimal_places=4, blank=True,
                                       null=True)  # Field name made lowercase.
    est_service = models.DecimalField(db_column='Est_Service', max_digits=19, decimal_places=4, blank=True,
                                      null=True)  # Field name made lowercase.
    est_labor_burden = models.DecimalField(db_column='Est_Labor_Burden', max_digits=19, decimal_places=4, blank=True,
                                           null=True)  # Field name made lowercase.
    est_machine_burden = models.DecimalField(db_column='Est_Machine_Burden', max_digits=19, decimal_places=4,
                                             blank=True, null=True)  # Field name made lowercase.
    est_ga_burden = models.DecimalField(db_column='Est_GA_Burden', max_digits=19, decimal_places=4, blank=True,
                                        null=True)  # Field name made lowercase.
    act_revenue = models.DecimalField(db_column='Act_Revenue', max_digits=19, decimal_places=4, blank=True,
                                      null=True)  # Field name made lowercase.
    act_scrap_quantity = models.IntegerField(db_column='Act_Scrap_Quantity', blank=True,
                                             null=True)  # Field name made lowercase.
    act_total_hrs = models.FloatField(db_column='Act_Total_Hrs', blank=True, null=True)  # Field name made lowercase.
    act_labor = models.DecimalField(db_column='Act_Labor', max_digits=19, decimal_places=4, blank=True,
                                    null=True)  # Field name made lowercase.
    act_material = models.DecimalField(db_column='Act_Material', max_digits=19, decimal_places=4, blank=True,
                                       null=True)  # Field name made lowercase.
    act_service = models.DecimalField(db_column='Act_Service', max_digits=19, decimal_places=4, blank=True,
                                      null=True)  # Field name made lowercase.
    act_labor_burden = models.DecimalField(db_column='Act_Labor_Burden', max_digits=19, decimal_places=4, blank=True,
                                           null=True)  # Field name made lowercase.
    act_machine_burden = models.DecimalField(db_column='Act_Machine_Burden', max_digits=19, decimal_places=4,
                                             blank=True, null=True)  # Field name made lowercase.
    act_ga_burden = models.DecimalField(db_column='Act_GA_Burden', max_digits=19, decimal_places=4, blank=True,
                                        null=True)  # Field name made lowercase.
    priority = models.SmallIntegerField(db_column='Priority', blank=True, null=True)  # Field name made lowercase.
    unit_price = models.FloatField(db_column='Unit_Price', blank=True, null=True)  # Field name made lowercase.
    total_price = models.DecimalField(db_column='Total_Price', max_digits=19, decimal_places=4, blank=True,
                                      null=True)  # Field name made lowercase.
    price_uofm = models.CharField(db_column='Price_UofM', max_length=4, blank=True,
                                  null=True)  # Field name made lowercase.
    currency_conv_rate = models.FloatField(db_column='Currency_Conv_Rate')  # Field name made lowercase.
    ...
    trade_date = models.DateTimeField(db_column='Trade_Date', blank=True, null=True)  # Field name made lowercase.
    commission_pct = models.FloatField(db_column='Commission_Pct', blank=True, null=True)  # Field name made lowercase.
    customer_po = models.CharField(db_column='Customer_PO', max_length=20, blank=True,
                                   null=True)  # Field name made lowercase.
    customer_po_ln = models.CharField(db_column='Customer_PO_LN', max_length=6, blank=True,
                                      null=True)  # Field name made lowercase.
    ...
    profit_markup = models.CharField(db_column='Profit_Markup', max_length=1, blank=True,
                                     null=True)  # Field name made lowercase.
    prepaid_amt = models.DecimalField(db_column='Prepaid_Amt', max_digits=19, decimal_places=4, blank=True,
                                      null=True)  # Field name made lowercase.
    ...
    price_unit_conv = models.FloatField(db_column='Price_Unit_Conv', blank=True,
                                        null=True)  # Field name made lowercase.
    holder_id = models.CharField(db_column='Holder_ID', max_length=50, blank=True,
                                 null=True)  # Field name made lowercase.
    source = models.CharField(db_column='Source', max_length=20, blank=True, null=True)  # Field name made lowercase.
    order_taken_by = models.CharField(db_column='Order_Taken_By', max_length=50, blank=True,
                                      null=True)  # Field name made lowercase.
    ...
    prepaid_tax_amount = models.DecimalField(db_column='Prepaid_Tax_Amount', max_digits=19, decimal_places=4,
                                             blank=True, null=True)  # Field name made lowercase.
    prepaid_trade_amt = models.DecimalField(db_column='Prepaid_Trade_Amt', max_digits=19, decimal_places=4, blank=True,
                                            null=True)  # Field name made lowercase.
    last_updated_by = models.CharField(db_column='Last_Updated_By', max_length=50, blank=True,
                                       null=True)  # Field name made lowercase.
    commissionincluded = models.BooleanField(db_column='CommissionIncluded')  # Field name made lowercase.
...
class JobException(TruncatedModel):
    job_exception = models.AutoField(db_column='Job_Exception', primary_key=True)  # Field name made lowercase.
    requirement = models.CharField(db_column='Requirement', max_length=30, blank=True,
                                   null=True)  # Field name made lowercase.
    ...
    material_req_oid = models.CharField(db_column='Material_Req_OID', max_length=36, blank=True,
                                        null=True)  # Field name made lowercase.
    exception_type = models.IntegerField(db_column='Exception_Type', blank=True,
                                         null=True)  # Field name made lowercase.
...
class JobOperation(TruncatedModel):
    job_operationkey = models.AutoField(db_column='Job_OperationKey', primary_key=True)  # Field name made lowercase.
    job_operation = models.IntegerField(db_column='Job_Operation', unique=True, blank=True,
                                        null=True)  # Field name made lowercase.
    vendor = models.ForeignKey('Vendor', models.DO_NOTHING, db_column='Vendor', blank=True,
                               null=True)  # Field name made lowercase.
    work_center = models.ForeignKey('WorkCenter', models.DO_NOTHING, db_column='Work_Center', blank=True,
    ...
    operation_service = models.CharField(db_column='Operation_Service', max_length=10, blank=True,
                                         null=True)  # Field name made lowercase.
    ...
    run_method = models.CharField(db_column='Run_Method', max_length=8, blank=True,
                                  null=True)  # Field name made lowercase.
    run = models.FloatField(db_column='Run', blank=True, null=True)  # Field name made lowercase.
    est_run_per_part = models.FloatField(db_column='Est_Run_Per_Part', blank=True,
                                         null=True)  # Field name made lowercase.
    ...
    est_setup_labor = models.DecimalField(db_column='Est_Setup_Labor', max_digits=19, decimal_places=4, blank=True,
                                          null=True)  # Field name made lowercase.
    est_run_labor = models.DecimalField(db_column='Est_Run_Labor', max_digits=19, decimal_places=4, blank=True,
                                        null=True)  # Field name made lowercase.
    est_labor_burden = models.DecimalField(db_column='Est_Labor_Burden', max_digits=19, decimal_places=4, blank=True,
                                           null=True)  # Field name made lowercase.
    est_machine_burden = models.DecimalField(db_column='Est_Machine_Burden', max_digits=19, decimal_places=4,
    ...
    est_ga_burden = models.DecimalField(db_column='Est_GA_Burden', max_digits=19, decimal_places=4, blank=True,
                                        null=True)  # Field name made lowercase.
    est_required_qty = models.IntegerField(db_column='Est_Required_Qty', blank=True,
                                           null=True)  # Field name made lowercase.
    est_unit_cost = models.FloatField(db_column='Est_Unit_Cost')  # Field name made lowercase.
    est_addl_cost = models.DecimalField(db_column='Est_Addl_Cost', max_digits=19, decimal_places=4, blank=True,
                                        null=True)  # Field name made lowercase.
    est_total_cost = models.DecimalField(db_column='Est_Total_Cost', max_digits=19, decimal_places=4, blank=True,
                                         null=True)  # Field name made lowercase.
    ...
    act_setup_labor = models.DecimalField(db_column='Act_Setup_Labor', max_digits=19, decimal_places=4, blank=True,
                                          null=True)  # Field name made lowercase.
    act_run_labor = models.DecimalField(db_column='Act_Run_Labor', max_digits=19, decimal_places=4, blank=True,
                                        null=True)  # Field name made lowercase.
    act_labor_burden = models.DecimalField(db_column='Act_Labor_Burden', max_digits=19, decimal_places=4, blank=True,
                                           null=True)  # Field name made lowercase.
    act_machine_burden = models.DecimalField(db_column='Act_Machine_Burden', max_digits=19, decimal_places=4,
    ...
    act_addl_cost = models.DecimalField(db_column='Act_Addl_Cost', max_digits=19, decimal_places=4, blank=True,
                                        null=True)  # Field name made lowercase.
    addl_cost_desc = models.CharField(db_column='Addl_Cost_Desc', max_length=15, blank=True,
                                      null=True)  # Field name made lowercase.
    act_total_cost = models.DecimalField(db_column='Act_Total_Cost', max_digits=19, decimal_places=4, blank=True,
                                         null=True)  # Field name made lowercase.
    setup_pct_complete = models.FloatField(db_column='Setup_Pct_Complete', blank=True,
                                           null=True)  # Field name made lowercase.
    run_pct_complete = models.FloatField(db_column='Run_Pct_Complete', blank=True,
                                         null=True)  # Field name made lowercase.
    ...
    overlap_method = models.CharField(db_column='Overlap_Method', max_length=3, blank=True,
                                      null=True)  # Field name made lowercase.
    ...
    lead_days = models.SmallIntegerField(db_column='Lead_Days', blank=True, null=True)  # Field name made lowercase.
    sched_ovl_start_old = models.DateTimeField(db_column='Sched_Ovl_Start_OLD', blank=True,
                                               null=True)  # Field name made lowercase.
    sched_ovl_start_hr_old = models.FloatField(db_column='Sched_Ovl_Start_Hr_OLD', blank=True,
                                               null=True)  # Field name made lowercase.
    sched_start = models.DateTimeField(db_column='Sched_Start', blank=True, null=True)  # Field name made lowercase.
    sched_start_hr_old = models.FloatField(db_column='Sched_Start_Hr_OLD', blank=True,
                                           null=True)  # Field name made lowercase.
    sched_end = models.DateTimeField(db_column='Sched_End', blank=True, null=True)  # Field name made lowercase.
    sched_end_hr_old = models.FloatField(db_column='Sched_End_Hr_OLD', blank=True,
                                         null=True)  # Field name made lowercase.
    ...
    minimum_chg_amt = models.DecimalField(db_column='Minimum_Chg_Amt', max_digits=19,
                                          decimal_places=4)  # Field name made lowercase.
    cost_unit = models.CharField(db_column='Cost_Unit', max_length=4, blank=True,
                                 null=True)  # Field name made lowercase.
    ...
    rwk_setup_labor = models.DecimalField(db_column='Rwk_Setup_Labor', max_digits=19, decimal_places=4, blank=True,
                                          null=True)  # Field name made lowercase.
    rwk_run_labor = models.DecimalField(db_column='Rwk_Run_Labor', max_digits=19, decimal_places=4, blank=True,
                                        null=True)  # Field name made lowercase.
    rwk_labor_burden = models.DecimalField(db_column='Rwk_Labor_Burden', max_digits=19, decimal_places=4, blank=True,
                                           null=True)  # Field name made lowercase.
    rwk_machine_burden = models.DecimalField(db_column='Rwk_Machine_Burden', max_digits=19, decimal_places=4,
                                             blank=True, null=True)  # Field name made lowercase.
    rwk_ga_burden = models.DecimalField(db_column='Rwk_GA_Burden', max_digits=19, decimal_places=4, blank=True,
                                        null=True)  # Field name made lowercase.
    ...
    holder_id = models.CharField(db_column='Holder_ID', max_length=50, blank=True,
                                 null=True)  # Field name made lowercase.
    op_group = models.CharField(db_column='Op_Group', max_length=50, blank=True,
                                null=True)  # Field name made lowercase.
    act_run_labor_hrs = models.FloatField(db_column='Act_Run_Labor_Hrs', blank=True,
                                          null=True)  # Field name made lowercase.
    ...
    rwk_run_labor_hrs = models.FloatField(db_column='Rwk_Run_Labor_Hrs', blank=True,
                                          null=True)  # Field name made lowercase.
    ...
    act_setup_labor_hrs = models.FloatField(db_column='Act_Setup_Labor_Hrs', blank=True,
                                            null=True)  # Field name made lowercase.
    rwk_setup_labor_hrs = models.FloatField(db_column='Rwk_Setup_Labor_Hrs', blank=True,
                                            null=True)  # Field name made lowercase.
    floor_notes = models.TextField(db_column='Floor_Notes', blank=True,
                                   null=True)  # Field name made lowercase. This field type is a guess.
    objectid = models.CharField(db_column='ObjectID', unique=True, max_length=36)  # Field name made lowercase.
    job_oid = models.CharField(db_column='Job_OID', max_length=36, blank=True, null=True)  # Field name made lowercase.
    sched_resources = models.FloatField(db_column='Sched_Resources', blank=True,
                                        null=True)  # Field name made lowercase.
    lag_hours = models.FloatField(db_column='Lag_Hours', blank=True, null=True)  # Field name made lowercase.
    workcenter_oid = models.CharField(db_column='WorkCenter_OID', max_length=36, blank=True,
                                      null=True)  # Field name made lowercase.
    ...
    sb_orig_oid = models.CharField(db_column='SB_Orig_OID', max_length=36, blank=True,
                                   null=True)  # Field name made lowercase.
    ...
    sb_runmethod = models.CharField(db_column='SB_RunMethod', max_length=8, blank=True,
                                    null=True)  # Field name made lowercase.
...
class JobOperationTime(TruncatedModel):
    ...
    overtime_factor = models.FloatField(db_column='Overtime_Factor', blank=True,
                                        null=True)  # Field name made lowercase.
    ...
    run_pct_complete = models.FloatField(db_column='Run_Pct_Complete', blank=True,
                                         null=True)  # Field name made lowercase.
    setup_labor_rate = models.FloatField(db_column='Setup_Labor_Rate', blank=True,
                                         null=True)  # Field name made lowercase.
    ...
    machine_burden = models.DecimalField(db_column='Machine_Burden', max_digits=19, decimal_places=4, blank=True,
                                         null=True)  # Field name made lowercase.
    ga_burden = models.DecimalField(db_column='GA_Burden', max_digits=19, decimal_places=4, blank=True,
                                    null=True)  # Field name made lowercase.
    note_text = models.TextField(db_column='Note_Text', blank=True,
                                 null=True)  # Field name made lowercase. This field type is a guess.
    last_updated = models.DateTimeField(db_column='Last_Updated')  # Field name made lowercase.
    entry_type = models.SmallIntegerField(db_column='Entry_Type')  # Field name made lowercase.
    job_operation_time = models.CharField(db_column='Job_Operation_Time', primary_key=True,
                                          max_length=50)  # Field name made lowercase.
    scrap_code = models.CharField(db_column='Scrap_Code', max_length=25, blank=True,
                                  null=True)  # Field name made lowercase.
    rwk_code = models.CharField(db_column='Rwk_Code', max_length=25, blank=True,
                                null=True)  # Field name made lowercase.
    ...
    overtime_hrs_7x = models.FloatField(db_column='Overtime_Hrs_7x', blank=True,
                                        null=True)  # Field name made lowercase.
    user_values = models.IntegerField(db_column='User_Values', blank=True, null=True)  # Field name made lowercase.
    objectid = models.CharField(db_column='ObjectID', unique=True, max_length=36)  # Field name made lowercase.
    job_operation_oid = models.CharField(db_column='Job_Operation_OID', max_length=36, blank=True,
                                         null=True)  # Field name made lowercase.
    employee_oid = models.CharField(db_column='Employee_OID', max_length=36, blank=True,
                                    null=True)  # Field name made lowercase.
...
class JournalEntry(TruncatedModel):
    journal_entrykey = models.AutoField(db_column='Journal_EntryKey', primary_key=True)  # Field name made lowercase.
    journal_entry = models.IntegerField(db_column='Journal_Entry', unique=True, blank=True,
                                        null=True)  # Field name made lowercase.
    gl_account = models.CharField(db_column='GL_Account', max_length=10, blank=True,
                                  null=True)  # Field name made lowercase.
    reference = models.CharField(db_column='Reference', max_length=15, blank=True,
                                 null=True)  # Field name made lowercase.
    ...
    last_updated = models.DateTimeField(db_column='Last_Updated')  # Field name made lowercase.
    originating_transaction = models.CharField(db_column='Originating_Transaction', max_length=50, blank=True,
                                               null=True)  # Field name made lowercase.
    statement_date = models.DateTimeField(db_column='Statement_Date', blank=True,
                                          null=True)  # Field name made lowercase.
    line_description = models.CharField(db_column='Line_Description', max_length=30, blank=True,
                                        null=True)  # Field name made lowercase.
    ...
    order_number = models.CharField(db_column='Order_Number', max_length=30, blank=True,
                                    null=True)  # Field name made lowercase.
    partner_type = models.IntegerField(db_column='Partner_Type', blank=True, null=True)  # Field name made lowercase.
    cust_trans_type = models.IntegerField(db_column='Cust_Trans_Type', blank=True,
                                          null=True)  # Field name made lowercase.
    ...
    item_description = models.CharField(db_column='Item_Description', max_length=30, blank=True,
                                        null=True)  # Field name made lowercase.
    location = models.CharField(db_column='Location', max_length=10, blank=True,
                                null=True)  # Field name made lowercase.
    cust_trans = models.CharField(db_column='Cust_Trans', max_length=50, blank=True,
                                  null=True)  # Field name made lowercase.
    currency_def = models.IntegerField(db_column='Currency_Def', blank=True, null=True)  # Field name made lowercase.
    holder_type = models.CharField(db_column='Holder_Type', max_length=50, blank=True,
                                   null=True)  # Field name made lowercase.
    mfg_holder_type = models.CharField(db_column='MFG_Holder_Type', max_length=50, blank=True,
                                       null=True)  # Field name made lowercase.
    mfg_holder_id = models.CharField(db_column='MFG_Holder_ID', max_length=50, blank=True,
                                     null=True)  # Field name made lowercase.
...
class Location(TruncatedModel):
    ...
    location = models.IntegerField(db_column='Location', unique=True, blank=True,
                                   null=True)  # Field name made lowercase.
    user_values = models.IntegerField(db_column='User_Values', blank=True, null=True)  # Field name made lowercase.
    warehouse = models.CharField(db_column='Warehouse', max_length=4, blank=True,
                                 null=True)  # Field name made lowercase.
...
class LookupType(TruncatedModel):
    ...
    param_sequence = models.IntegerField(db_column='Param_Sequence', blank=True,
                                         null=True)  # Field name made lowercase.
...
class Material(TruncatedModel):
    material = models.CharField(db_column='Material', primary_key=True, max_length=30)  # Field name made lowercase.
    primary_vendor = models.ForeignKey('Vendor', models.DO_NOTHING, db_column='Primary_Vendor', blank=True,
                                       null=True)  # Field name made lowercase.
    user_values = models.IntegerField(db_column='User_Values', blank=True, null=True)  # Field name made lowercase.
    shape = models.ForeignKey('Shapes', models.DO_NOTHING, db_column='Shape', blank=True,
                              null=True)  # Field name made lowercase.
    ...
    class_field = models.CharField(db_column='Class', max_length=10, blank=True,
    ...
    vendor_reference = models.CharField(db_column='Vendor_Reference', max_length=30, blank=True,
                                        null=True)  # Field name made lowercase.
    drawing = models.CharField(db_column='Drawing', max_length=30, blank=True, null=True)  # Field name made lowercase.
    ...
    note_text = models.TextField(db_column='Note_Text', blank=True,
                                 null=True)  # Field name made lowercase. This field type is a guess.
    last_updated = models.DateTimeField(db_column='Last_Updated')  # Field name made lowercase.
    gl_account = models.CharField(db_column='GL_Account', max_length=100, blank=True,
                                  null=True)  # Field name made lowercase.
    price_unit_conv = models.FloatField(db_column='Price_Unit_Conv', blank=True,
                                        null=True)  # Field name made lowercase.
    holder_id = models.CharField(db_column='Holder_ID', max_length=50, blank=True,
    ...
    is_weight_factor = models.FloatField(db_column='IS_Weight_Factor', blank=True,
                                         null=True)  # Field name made lowercase.
    is_thickness = models.FloatField(db_column='IS_Thickness', blank=True, null=True)  # Field name made lowercase.
    stock_item = models.CharField(db_column='Stock_Item', max_length=50, blank=True,
                                  null=True)  # Field name made lowercase.
    affects_schedule = models.NullBooleanField(db_column='Affects_Schedule')  # Field name made lowercase.
    objectid = models.CharField(db_column='ObjectID', unique=True, max_length=36)  # Field name made lowercase.
    shape_oid = models.CharField(db_column='Shape_OID', max_length=36, blank=True,
                                 null=True)  # Field name made lowercase.
    ...
    shelflifeuofm = models.CharField(db_column='ShelfLifeUofM', max_length=10, blank=True,
                                     null=True)  # Field name made lowercase.
...
class MaterialLocation(TruncatedModel):
    material_locationkey = models.AutoField(db_column='Material_LocationKey',
                                            primary_key=True)  # Field name made lowercase.
    material_location = models.IntegerField(db_column='Material_Location', unique=True, blank=True,
                                            null=True)  # Field name made lowercase.
    location_id = models.CharField(db_column='Location_ID', max_length=10)  # Field name made lowercase.
    material = models.ForeignKey(Material, models.DO_NOTHING, db_column='Material')  # Field name made lowercase.
...
class MaterialReq(AutoNumberMixin, TruncatedModel):
    ...
    material_req = models.IntegerField(db_column='Material_Req', unique=True, blank=True,
                                       null=True)  # Field name made lowercase.
    job_operation = models.IntegerField(db_column='Job_Operation', blank=True, null=True)  # Field name made lowercase.
    job = models.ForeignKey(Job, models.DO_NOTHING, db_column='Job')  # Field name made lowercase.
    material = models.CharField(db_column='Material', max_length=30, blank=True,
                                null=True)  # Field name made lowercase.
    vendor = models.ForeignKey('Vendor', models.DO_NOTHING, db_column='Vendor', blank=True,
                               null=True)  # Field name made lowercase.
    description = models.CharField(db_column='Description', max_length=30, blank=True,
    ...
    type = models.CharField(db_column='Type', max_length=1)  # Field name made lowercase.
    status = models.CharField(db_column='Status', max_length=1, blank=True, null=True)  # Field name made lowercase.
    quantity_per_basis = models.CharField(db_column='Quantity_Per_Basis', max_length=1, blank=True,
                                          null=True)  # Field name made lowercase.
    quantity_per = models.FloatField(db_column='Quantity_Per', blank=True, null=True)  # Field name made lowercase.
    ...
    est_total_cost = models.DecimalField(db_column='Est_Total_Cost', max_digits=19, decimal_places=4, blank=True,
                                         null=True)  # Field name made lowercase.
    addl_cost_desc = models.CharField(db_column='Addl_Cost_Desc', max_length=25, blank=True,
                                      null=True)  # Field name made lowercase.
    ...
    manual_link = models.BooleanField(db_column='Manual_Link')  # Field name made lowercase.
    due_date = models.DateTimeField(db_column='Due_Date', blank=True, null=True)  # Field name made lowercase.
    sched_start_date = models.DateTimeField(db_column='Sched_Start_Date', blank=True,
                                            null=True)  # Field name made lowercase.
    sched_end_date = models.DateTimeField(db_column='Sched_End_Date', blank=True,
                                          null=True)  # Field name made lowercase.
    vendor_reference = models.CharField(db_column='Vendor_Reference', max_length=30, blank=True,
                                        null=True)  # Field name made lowercase.
    note_text = models.TextField(db_column='Note_Text', blank=True,
    ...
    holder_id = models.CharField(db_column='Holder_ID', max_length=50, blank=True,
                                 null=True)  # Field name made lowercase.
    cost_uofm = models.CharField(db_column='Cost_UofM', max_length=4, blank=True,
                                 null=True)  # Field name made lowercase.
    cost_unit_conv = models.FloatField(db_column='Cost_Unit_Conv', blank=True, null=True)  # Field name made lowercase.
    quantity_multiplier = models.FloatField(db_column='Quantity_Multiplier', blank=True,
                                            null=True)  # Field name made lowercase.
    drawing_id = models.CharField(db_column='Drawing_ID', max_length=30, blank=True,
                                  null=True)  # Field name made lowercase.
    ...
    job_oid = models.CharField(db_column='Job_OID', max_length=36, blank=True, null=True)  # Field name made lowercase.
    affects_schedule = models.NullBooleanField(db_column='Affects_Schedule')  # Field name made lowercase.
    material_oid = models.CharField(db_column='Material_OID', max_length=36, blank=True,
                                    null=True)  # Field name made lowercase.
...
class MaterialTrans(TruncatedModel):
    material_transkey = models.AutoField(db_column='Material_TransKey', primary_key=True)  # Field name made lowercase.
    material_trans = models.IntegerField(db_column='Material_Trans', unique=True, blank=True,
                                         null=True)  # Field name made lowercase.
    vendor = models.CharField(db_column='Vendor', max_length=10, blank=True, null=True)  # Field name made lowercase.
    customer = models.CharField(db_column='Customer', max_length=10, blank=True,
                                null=True)  # Field name made lowercase.
    ...
    material = models.CharField(db_column='Material', max_length=30, blank=True,
                                null=True)  # Field name made lowercase.
    po_number = models.CharField(db_column='PO_Number', max_length=20, blank=True,
                                 null=True)  # Field name made lowercase.
    po_line = models.CharField(db_column='PO_Line', max_length=10, blank=True, null=True)  # Field name made lowercase.
    document = models.CharField(db_column='Document', max_length=15, blank=True,
                                null=True)  # Field name made lowercase.
    so_detail = models.IntegerField(db_column='SO_Detail', blank=True, null=True)  # Field name made lowercase.
    ...
    job_operation = models.IntegerField(db_column='Job_Operation', blank=True, null=True)  # Field name made lowercase.
    location_id = models.CharField(db_column='Location_ID', max_length=10, blank=True,
                                   null=True)  # Field name made lowercase.
    ...
    material_trans_date = models.DateTimeField(db_column='Material_Trans_Date', blank=True,
                                               null=True)  # Field name made lowercase.
    unit_cost = models.FloatField(db_column='Unit_Cost', blank=True, null=True)  # Field name made lowercase.
    addl_cost = models.FloatField(db_column='Addl_Cost', blank=True, null=True)  # Field name made lowercase.
    purch_unit_weight = models.FloatField(db_column='Purch_Unit_Weight', blank=True,
                                          null=True)  # Field name made lowercase.
    stock_uofm = models.CharField(db_column='Stock_UofM', max_length=4, blank=True,
                                  null=True)  # Field name made lowercase.
    cost_uofm = models.CharField(db_column='Cost_UofM', max_length=4, blank=True,
                                 null=True)  # Field name made lowercase.
    reason = models.CharField(db_column='Reason', max_length=15, blank=True, null=True)  # Field name made lowercase.
...
class OpGroup(TruncatedModel):
    op_group = models.CharField(db_column='Op_Group', primary_key=True, max_length=50)  # Field name made lowercase.
    work_center = models.CharField(db_column='Work_Center', max_length=10, blank=True,
                                   null=True)  # Field name made lowercase.
    ...
    schedule_start = models.DateTimeField(db_column='Schedule_Start', blank=True,
                                          null=True)  # Field name made lowercase.
    last_updated = models.DateTimeField(db_column='Last_Updated', blank=True, null=True)  # Field name made lowercase.
...
class Operation(TruncatedModel):
    operation = models.CharField(db_column='Operation', primary_key=True, max_length=10)  # Field name made lowercase.
    work_center = models.ForeignKey('WorkCenter', models.DO_NOTHING,
                                    db_column='Work_Center')  # Field name made lowercase.
    user_values = models.IntegerField(db_column='User_Values', blank=True, null=True)  # Field name made lowercase.
    description = models.CharField(db_column='Description', max_length=25, blank=True,
                                   null=True)  # Field name made lowercase.
    est_setup_hrs = models.FloatField(db_column='Est_Setup_Hrs', blank=True, null=True)  # Field name made lowercase.
...
class PoDetail(TruncatedModel):
    po_detailkey = models.AutoField(db_column='PO_DetailKey', primary_key=True)  # Field name made lowercase.
    po_detail = models.IntegerField(db_column='PO_Detail', unique=True, blank=True,
                                    null=True)  # Field name made lowercase.
    ...
    addl_cost_desc1 = models.CharField(db_column='Addl_Cost_Desc1', max_length=15, blank=True,
                                       null=True)  # Field name made lowercase.
    addl_cost_desc2 = models.CharField(db_column='Addl_Cost_Desc2', max_length=15, blank=True,
                                       null=True)  # Field name made lowercase.
    addl_cost_est_amt1 = models.DecimalField(db_column='Addl_Cost_Est_Amt1', max_digits=19, decimal_places=4,
                                             blank=True, null=True)  # Field name made lowercase.
    addl_cost_est_amt2 = models.DecimalField(db_column='Addl_Cost_Est_Amt2', max_digits=19, decimal_places=4,
                                             blank=True, null=True)  # Field name made lowercase.
    addl_cost_act_amt1 = models.DecimalField(db_column='Addl_Cost_Act_Amt1', max_digits=19, decimal_places=4,
                                             blank=True, null=True)  # Field name made lowercase.
    addl_cost_act_amt2 = models.DecimalField(db_column='Addl_Cost_Act_Amt2', max_digits=19, decimal_places=4,
                                             blank=True, null=True)  # Field name made lowercase.
    act_cost = models.DecimalField(db_column='Act_Cost', max_digits=19, decimal_places=4, blank=True,
                                   null=True)  # Field name made lowercase.
    est_ext_amount = models.DecimalField(db_column='Est_Ext_Amount', max_digits=19,
                                         decimal_places=4)  # Field name made lowercase.
    note_text = models.TextField(db_column='Note_Text', blank=True,
                                 null=True)  # Field name made lowercase. This field type is a guess.
    ext_description = models.TextField(db_column='Ext_Description', blank=True,
    ...
    gl_account = models.CharField(db_column='GL_Account', max_length=100, blank=True,
                                  null=True)  # Field name made lowercase.
    line_revision = models.CharField(db_column='Line_Revision', max_length=4, blank=True,
                                     null=True)  # Field name made lowercase.
    holder_id = models.CharField(db_column='Holder_ID', max_length=50, blank=True,
                                 null=True)  # Field name made lowercase.
    tax_code = models.CharField(db_column='Tax_Code', max_length=15, blank=True,
    ...
    awarded_vendor = models.CharField(db_column='Awarded_Vendor', max_length=10, blank=True,
                                      null=True)  # Field name made lowercase.
    ...
    objectid = models.CharField(db_column='ObjectID', unique=True, max_length=36)  # Field name made lowercase.
    po_header_oid = models.CharField(db_column='PO_Header_OID', max_length=36, blank=True,
                                     null=True)  # Field name made lowercase.
...
class PoHeader(TruncatedModel):
    ...
    terms = models.CharField(db_column='Terms', max_length=15, blank=True, null=True)  # Field name made lowercase.
    contact = models.IntegerField(db_column='Contact', blank=True, null=True)  # Field name made lowercase.
    drop_ship_ship_to = models.IntegerField(db_column='Drop_Ship_Ship_To', blank=True,
                                            null=True)  # Field name made lowercase.
    drop_ship_contact = models.IntegerField(db_column='Drop_Ship_Contact', blank=True,
                                            null=True)  # Field name made lowercase.
    drop_ship = models.CharField(db_column='Drop_Ship', max_length=10, blank=True,
                                 null=True)  # Field name made lowercase.
    drop_ship_customer = models.CharField(db_column='Drop_Ship_Customer', max_length=10, blank=True,
                                          null=True)  # Field name made lowercase.
    order_date = models.DateTimeField(db_column='Order_Date')  # Field name made lowercase.
    due_date = models.DateTimeField(db_column='Due_Date', blank=True, null=True)  # Field name made lowercase.
    print_date = models.DateTimeField(db_column='Print_Date', blank=True, null=True)  # Field name made lowercase.
    ...
    status = models.CharField(db_column='Status', max_length=8)  # Field name made lowercase.
    issued_by = models.CharField(db_column='Issued_By', max_length=30, blank=True,
                                 null=True)  # Field name made lowercase.
    currency_conv_rate = models.FloatField(db_column='Currency_Conv_Rate')  # Field name made lowercase.
    trade_currency = models.IntegerField(db_column='Trade_Currency', blank=True,
                                         null=True)  # Field name made lowercase.
...
class PacklistDetail(TruncatedModel):
    packlist_detailkey = models.AutoField(db_column='Packlist_DetailKey',
                                          primary_key=True)  # Field name made lowercase.
    packlist_detail = models.IntegerField(db_column='Packlist_Detail', unique=True, blank=True,
                                          null=True)  # Field name made lowercase.
    packlist = models.ForeignKey('PacklistHeader', models.DO_NOTHING,
                                 db_column='Packlist')  # Field name made lowercase.
    job = models.CharField(db_column='Job', max_length=10, blank=True, null=True)  # Field name made lowercase.
    job_operation = models.IntegerField(db_column='Job_Operation', blank=True, null=True)  # Field name made lowercase.
    material_trans = models.IntegerField(db_column='Material_Trans', blank=True,
                                         null=True)  # Field name made lowercase.
    ...
    po_number = models.CharField(db_column='PO_Number', max_length=20, blank=True,
                                 null=True)  # Field name made lowercase.
    due_date = models.DateTimeField(db_column='Due_Date', blank=True, null=True)  # Field name made lowercase.
    original_packlist = models.IntegerField(db_column='Original_Packlist', blank=True,
                                            null=True)  # Field name made lowercase.
    reopen_delivery = models.BooleanField(db_column='Reopen_Delivery')  # Field name made lowercase.
    tracking_nbr = models.CharField(db_column='Tracking_Nbr', max_length=20, blank=True,
                                    null=True)  # Field name made lowercase.
    unit_price = models.FloatField(db_column='Unit_Price', blank=True, null=True)  # Field name made lowercase.
    price_uofm = models.CharField(db_column='Price_UofM', max_length=4, blank=True,
                                  null=True)  # Field name made lowercase.
    ...
    backorder_qty = models.FloatField(db_column='Backorder_Qty')  # Field name made lowercase.
    instructions = models.TextField(db_column='Instructions', blank=True,
                                    null=True)  # Field name made lowercase. This field type is a guess.
    note_text = models.TextField(db_column='Note_Text', blank=True,
                                 null=True)  # Field name made lowercase. This field type is a guess.
    last_updated = models.DateTimeField(db_column='Last_Updated')  # Field name made lowercase.
    ...
    bol_comments = models.TextField(db_column='BOL_Comments', blank=True,
                                    null=True)  # Field name made lowercase. This field type is a guess.
    ...
    nmfc_code = models.CharField(db_column='NMFC_Code', max_length=15, blank=True,
                                 null=True)  # Field name made lowercase.
    ...
    freight_class = models.CharField(db_column='Freight_Class', max_length=15, blank=True,
                                     null=True)  # Field name made lowercase.
    objectid = models.CharField(db_column='ObjectID', unique=True, max_length=36)  # Field name made lowercase.
    job_operation_oid = models.CharField(db_column='Job_Operation_OID', max_length=36, blank=True,
                                         null=True)  # Field name made lowercase.
    po_header_oid = models.CharField(db_column='PO_Header_OID', max_length=36, blank=True,
                                     null=True)  # Field name made lowercase.
    packlist_oid = models.CharField(db_column='Packlist_OID', max_length=36, blank=True,
                                    null=True)  # Field name made lowercase.
    lot = models.CharField(db_column='Lot', max_length=20, blank=True, null=True)  # Field name made lowercase.
...
class PacklistHeader(TruncatedModel):
    packlist = models.CharField(db_column='Packlist', primary_key=True, max_length=8)  # Field name made lowercase.
    customer_vendor = models.CharField(db_column='Customer_Vendor', max_length=10, blank=True,
                                       null=True)  # Field name made lowercase.
    invoice = models.CharField(db_column='Invoice', max_length=50, blank=True, null=True)  # Field name made lowercase.
    ship_to = models.IntegerField(db_column='Ship_To', blank=True, null=True)  # Field name made lowercase.
    ship_via = models.CharField(db_column='Ship_Via', max_length=15, blank=True,
    ...
    last_updated = models.DateTimeField(db_column='Last_Updated')  # Field name made lowercase.
    freight_amt = models.FloatField(db_column='Freight_Amt', blank=True, null=True)  # Field name made lowercase.
    bol_number = models.CharField(db_column='BOL_Number', max_length=10, blank=True,
                                  null=True)  # Field name made lowercase.
    carrier_bill_to = models.IntegerField(db_column='Carrier_Bill_To', blank=True,
                                          null=True)  # Field name made lowercase.
    bol_terms = models.SmallIntegerField(db_column='BOL_Terms', blank=True, null=True)  # Field name made lowercase.
    third_party_acct = models.CharField(db_column='Third_Party_Acct', max_length=20, blank=True,
                                        null=True)  # Field name made lowercase.
    objectid = models.CharField(db_column='ObjectID', unique=True, max_length=36)  # Field name made lowercase.
...
class Preferences(TruncatedModel):
    preferenceskey = models.AutoField(db_column='PreferencesKey', primary_key=True)  # Field name made lowercase.
    preferences = models.IntegerField(db_column='Preferences', unique=True, blank=True,
                                      null=True)  # Field name made lowercase.
    system_base_currency = models.IntegerField(db_column='System_Base_Currency', blank=True,
                                               null=True)  # Field name made lowercase.
    ...
    wc_rate = models.DecimalField(db_column='WC_Rate', max_digits=19, decimal_places=4, blank=True,
                                  null=True)  # Field name made lowercase.
    ...
    transfer_cost_method = models.CharField(db_column='Transfer_Cost_Method',
                                            max_length=10)  # Field name made lowercase.
    ...
    price_unit_conv = models.FloatField(db_column='Price_Unit_Conv', blank=True,
                                        null=True)  # Field name made lowercase.
    price_unit = models.CharField(db_column='Price_Unit', max_length=4, blank=True,
                                  null=True)  # Field name made lowercase.
    company_code = models.CharField(db_column='Company_Code', max_length=50, blank=True,
                                    null=True)  # Field name made lowercase.
    post_transactions = models.NullBooleanField(db_column='Post_Transactions')  # Field name made lowercase.
    quote_decimal_places = models.IntegerField(db_column='Quote_Decimal_Places', blank=True,
                                               null=True)  # Field name made lowercase.
    freight_class = models.CharField(db_column='Freight_Class', max_length=15, blank=True,
                                     null=True)  # Field name made lowercase.
    default_tran_limit = models.SmallIntegerField(db_column='Default_Tran_Limit', blank=True,
                                                  null=True)  # Field name made lowercase.
    home_prompt = models.CharField(db_column='Home_Prompt', max_length=15, blank=True,
                                   null=True)  # Field name made lowercase.
    ...
    synergyurl = models.CharField(db_column='SynergyURL', max_length=255, blank=True,
                                  null=True)  # Field name made lowercase.
    synergysqlserver = models.CharField(db_column='SynergySQLServer', max_length=255, blank=True,
                                        null=True)  # Field name made lowercase.
    synergysqldb = models.CharField(db_column='SynergySQLDB', max_length=255, blank=True,
                                    null=True)  # Field name made lowercase.
    synergydbprefix = models.CharField(db_column='SynergyDBPrefix', max_length=255, blank=True,
                                       null=True)  # Field name made lowercase.
    objectid = models.CharField(db_column='ObjectID', unique=True, max_length=36)  # Field name made lowercase.
    material_affects_schedule = models.NullBooleanField(
        db_column='Material_Affects_Schedule')  # Field name made lowercase.
    allow_prior_schedule = models.NullBooleanField(db_column='Allow_Prior_Schedule')  # Field name made lowercase.
    qualitysystemurl = models.CharField(db_column='QualitySystemURL', max_length=255, blank=True,
                                        null=True)  # Field name made lowercase.
    win_probability = models.IntegerField(db_column='Win_Probability', blank=True,
                                          null=True)  # Field name made lowercase.
    expiration_days = models.IntegerField(db_column='Expiration_Days', blank=True,
                                          null=True)  # Field name made lowercase.
    ...
    autologoutoption = models.IntegerField(db_column='AutoLogoutOption', blank=True,
                                           null=True)  # Field name made lowercase.
    autologoutidletime = models.FloatField(db_column='AutoLogoutIdleTime', blank=True,
                                           null=True)  # Field name made lowercase.
    ...
    unipoint_tokenkey = models.CharField(db_column='uniPoint_TokenKey', max_length=30, blank=True,
                                         null=True)  # Field name made lowercase.
    ...
    unipoint_server_path = models.CharField(db_column='uniPoint_Server_Path', max_length=250, blank=True,
                                            null=True)  # Field name made lowercase.
...
class PriceBreak(TruncatedModel):
    price_breakkey = models.AutoField(db_column='Price_BreakKey', primary_key=True)  # Field name made lowercase.
    price_break = models.IntegerField(db_column='Price_Break', unique=True, blank=True,
                                      null=True)  # Field name made lowercase.
    material = models.CharField(db_column='Material', max_length=30, blank=True,
                                null=True)  # Field name made lowercase.
    ...
    sell_price = models.FloatField(db_column='Sell_Price')  # Field name made lowercase.
    last_updated = models.DateTimeField(db_column='Last_Updated')  # Field name made lowercase.
    vendor_material = models.CharField(db_column='Vendor_Material', max_length=50, blank=True,
                                       null=True)  # Field name made lowercase.
...
class Quote(TruncatedModel):
    ...
    quoted_by = models.CharField(db_column='Quoted_By', max_length=30, blank=True,
                                 null=True)  # Field name made lowercase.
    part_number = models.CharField(db_column='Part_Number', max_length=30, blank=True,
                                   null=True)  # Field name made lowercase.
    rev = models.CharField(db_column='Rev', max_length=8, blank=True, null=True)  # Field name made lowercase.
    ...
    ext_description = models.TextField(db_column='Ext_Description', blank=True,
                                       null=True)  # Field name made lowercase. This field type is a guess.
    drawing = models.CharField(db_column='Drawing', max_length=30, blank=True, null=True)  # Field name made lowercase.
    reference = models.CharField(db_column='Reference', max_length=16, blank=True,
                                 null=True)  # Field name made lowercase.
    commission_pct = models.FloatField(db_column='Commission_Pct', blank=True, null=True)  # Field name made lowercase.
    type = models.CharField(db_column='Type', max_length=8, blank=True, null=True)  # Field name made lowercase.
    certs_required = models.BooleanField(db_column='Certs_Required')  # Field name made lowercase.
    ...
    assembly_id = models.CharField(db_column='Assembly_ID', max_length=5, blank=True,
                                   null=True)  # Field name made lowercase.
    win_probability = models.IntegerField(db_column='Win_Probability', blank=True,
                                          null=True)  # Field name made lowercase.
...
class QuoteAddlCharge(TruncatedModel):
    quote_addl_chargekey = models.AutoField(db_column='Quote_Addl_ChargeKey',
                                            primary_key=True)  # Field name made lowercase.
    addl_charge = models.IntegerField(db_column='Addl_Charge', unique=True, blank=True,
                                      null=True)  # Field name made lowercase.
    ...
    description = models.CharField(db_column='Description', max_length=25, blank=True,
                                   null=True)  # Field name made lowercase.
    est_price = models.DecimalField(db_column='Est_Price', max_digits=19, decimal_places=4, blank=True,
                                    null=True)  # Field name made lowercase.
    job_revenue = models.BooleanField(db_column='Job_Revenue')  # Field name made lowercase.
    commissionable = models.BooleanField(db_column='Commissionable')  # Field name made lowercase.
    note_text = models.TextField(db_column='Note_Text', blank=True,
...
class QuoteOperation(TruncatedModel):
    quote_operationkey = models.AutoField(db_column='Quote_OperationKey',
                                          primary_key=True)  # Field name made lowercase.
    quote_operation = models.IntegerField(db_column='Quote_Operation', unique=True, blank=True,
                                          null=True)  # Field name made lowercase.
    vendor = models.ForeignKey('Vendor', models.DO_NOTHING, db_column='Vendor', blank=True,
                               null=True)  # Field name made lowercase.
    work_center = models.ForeignKey('WorkCenter', models.DO_NOTHING, db_column='Work_Center', blank=True,
                                    null=True)  # Field name made lowercase.
    quote = models.ForeignKey(Quote, models.DO_NOTHING, db_column='Quote')  # Field name made lowercase.
    wc_vendor = models.CharField(db_column='WC_Vendor', max_length=10, blank=True,
                                 null=True)  # Field name made lowercase.
    description = models.CharField(db_column='Description', max_length=25, blank=True,
                                   null=True)  # Field name made lowercase.
    run = models.FloatField(db_column='Run', blank=True, null=True)  # Field name made lowercase.
    ...
    fixed_rate = models.BooleanField(db_column='Fixed_Rate')  # Field name made lowercase.
    trade_date = models.DateTimeField(db_column='Trade_Date', blank=True, null=True)  # Field name made lowercase.
    run_labor_rate = models.DecimalField(db_column='Run_Labor_Rate', max_digits=19,
                                         decimal_places=4)  # Field name made lowercase.
    setup_labor_rate = models.DecimalField(db_column='Setup_Labor_Rate', max_digits=19,
                                           decimal_places=4)  # Field name made lowercase.
    run_labor_burden_rate = models.DecimalField(db_column='Run_Labor_Burden_Rate', max_digits=19,
                                                decimal_places=4)  # Field name made lowercase.
    setup_labor_burden_rate = models.DecimalField(db_column='Setup_Labor_Burden_Rate', max_digits=19,
                                                  decimal_places=4)  # Field name made lowercase.
    machine_burden_rate = models.DecimalField(db_column='Machine_Burden_Rate', max_digits=19,
                                              decimal_places=4)  # Field name made lowercase.
    ga_burden_rate = models.DecimalField(db_column='GA_Burden_Rate', max_digits=19,
                                         decimal_places=4)  # Field name made lowercase.
    note_text = models.TextField(db_column='Note_Text', blank=True,
                                 null=True)  # Field name made lowercase. This field type is a guess.
    last_updated = models.DateTimeField(db_column='Last_Updated')  # Field name made lowercase.
...
class QuoteOperationQty(TruncatedModel):
    quote_operation_qtykey = models.AutoField(db_column='Quote_Operation_QtyKey',
                                              primary_key=True)  # Field name made lowercase.
    quote_operation_qty = models.IntegerField(db_column='Quote_Operation_Qty', unique=True, blank=True,
                                              null=True)  # Field name made lowercase.
    quote_operation = models.IntegerField(db_column='Quote_Operation', blank=True,
                                          null=True)  # Field name made lowercase.
    ...
    est_setup_labor = models.DecimalField(db_column='Est_Setup_Labor', max_digits=19,
                                          decimal_places=4)  # Field name made lowercase.
    est_run_labor = models.DecimalField(db_column='Est_Run_Labor', max_digits=19,
                                        decimal_places=4)  # Field name made lowercase.
    est_labor_burden = models.DecimalField(db_column='Est_Labor_Burden', max_digits=19,
                                           decimal_places=4)  # Field name made lowercase.
    est_machine_burden = models.DecimalField(db_column='Est_Machine_Burden', max_digits=19,
                                             decimal_places=4)  # Field name made lowercase.
    est_ga_burden = models.DecimalField(db_column='Est_GA_Burden', max_digits=19,
                                        decimal_places=4)  # Field name made lowercase.
    sequence = models.SmallIntegerField(db_column='Sequence')  # Field name made lowercase.
    priority = models.SmallIntegerField(db_column='Priority')  # Field name made lowercase.
    inside_oper = models.BooleanField(db_column='Inside_Oper')  # Field name made lowercase.
    est_unit_cost = models.FloatField(db_column='Est_Unit_Cost')  # Field name made lowercase.
    est_addl_cost = models.DecimalField(db_column='Est_Addl_Cost', max_digits=19,
                                        decimal_places=4)  # Field name made lowercase.
    addl_cost_desc = models.CharField(db_column='Addl_Cost_Desc', max_length=15, blank=True,
                                      null=True)  # Field name made lowercase.
    offset_rate = models.DecimalField(db_column='Offset_Rate', max_digits=19,
                                      decimal_places=4)  # Field name made lowercase.
    est_total_cost = models.DecimalField(db_column='Est_Total_Cost', max_digits=19,
                                         decimal_places=4)  # Field name made lowercase.
...
class QuoteQty(TruncatedModel):
    quote_qtykey = models.AutoField(db_column='Quote_QtyKey', primary_key=True)  # Field name made lowercase.
    quote_qty_key = models.IntegerField(db_column='Quote_Qty_Key', unique=True, blank=True,
                                        null=True)  # Field name made lowercase.
    quote = models.ForeignKey(Quote, models.DO_NOTHING, db_column='Quote')  # Field name made lowercase.
    parent_quote_qty_key = models.IntegerField(db_column='Parent_Quote_Qty_Key', blank=True,
                                               null=True)  # Field name made lowercase.
    ...
    est_ga_burden = models.DecimalField(db_column='Est_GA_Burden', max_digits=19, decimal_places=4, blank=True,
                                        null=True)  # Field name made lowercase.
    unit_price = models.FloatField(db_column='Unit_Price', blank=True, null=True)  # Field name made lowercase.
    quoted_unit_price = models.FloatField(db_column='Quoted_Unit_Price', blank=True,
                                          null=True)  # Field name made lowercase.
    total_price = models.DecimalField(db_column='Total_Price', max_digits=19, decimal_places=4, blank=True,
                                      null=True)  # Field name made lowercase.
    price_uofm = models.CharField(db_column='Price_UofM', max_length=4, blank=True,
                                  null=True)  # Field name made lowercase.
    profit_pct = models.FloatField(db_column='Profit_Pct', blank=True, null=True)  # Field name made lowercase.
    labor_markup_pct = models.FloatField(db_column='Labor_Markup_Pct', blank=True,
                                         null=True)  # Field name made lowercase.
    mat_markup_pct = models.FloatField(db_column='Mat_Markup_Pct', blank=True, null=True)  # Field name made lowercase.
    serv_markup_pct = models.FloatField(db_column='Serv_Markup_Pct', blank=True,
                                        null=True)  # Field name made lowercase.
    labor_burden_markup_pct = models.FloatField(db_column='Labor_Burden_Markup_Pct')  # Field name made lowercase.
    machine_burden_markup_pct = models.FloatField(db_column='Machine_Burden_Markup_Pct')  # Field name made lowercase.
    ga_burden_markup_pct = models.FloatField(db_column='GA_Burden_Markup_Pct')  # Field name made lowercase.
    ...
    price_unit_conv = models.FloatField(db_column='Price_Unit_Conv', blank=True,
                                        null=True)  # Field name made lowercase.
    decimal_places = models.IntegerField(db_column='Decimal_Places', blank=True,
                                         null=True)  # Field name made lowercase.
...
class QuoteReq(TruncatedModel):
    quote_reqkey = models.AutoField(db_column='Quote_ReqKey', primary_key=True)  # Field name made lowercase.
    quote_req = models.IntegerField(db_column='Quote_Req', unique=True, blank=True,
                                    null=True)  # Field name made lowercase.
    quote = models.ForeignKey(Quote, models.DO_NOTHING, db_column='Quote')  # Field name made lowercase.
    material = models.CharField(db_column='Material', max_length=30, blank=True,
                                null=True)  # Field name made lowercase.
...
class QuoteReqQty(TruncatedModel):
    quote_req_qtykey = models.AutoField(db_column='Quote_Req_QtyKey', primary_key=True)  # Field name made lowercase.
    quote_req_qty = models.IntegerField(db_column='Quote_Req_Qty', unique=True, blank=True,
                                        null=True)  # Field name made lowercase.
...
class Rfq(TruncatedModel):
    ...
    comments = models.TextField(db_column='Comments', blank=True,
                                null=True)  # Field name made lowercase. This field type is a guess.
    reference = models.CharField(db_column='Reference', max_length=30, blank=True,
                                 null=True)  # Field name made lowercase.
    status_date = models.DateTimeField(db_column='Status_Date', blank=True, null=True)  # Field name made lowercase.
    ...
    trade_date = models.DateTimeField(db_column='Trade_Date', blank=True, null=True)  # Field name made lowercase.
    currency_conv_rate = models.FloatField(db_column='Currency_Conv_Rate', blank=True,
                                           null=True)  # Field name made lowercase.
    ship_via = models.CharField(db_column='Ship_Via', max_length=15, blank=True,
                                null=True)  # Field name made lowercase.
    ...
    quoted_by = models.CharField(db_column='Quoted_By', max_length=30, blank=True,
                                 null=True)  # Field name made lowercase.
    submitted_date = models.DateTimeField(db_column='Submitted_Date', blank=True,
                                          null=True)  # Field name made lowercase.
    submittal_due_date = models.DateTimeField(db_column='Submittal_Due_Date', blank=True,
                                              null=True)  # Field name made lowercase.
    expiration_date = models.DateTimeField(db_column='Expiration_Date', blank=True,
                                           null=True)  # Field name made lowercase.
    status = models.CharField(db_column='Status', max_length=8, blank=True, null=True)  # Field name made lowercase.
    followup_date = models.DateTimeField(db_column='Followup_Date', blank=True, null=True)  # Field name made lowercase.
    act_followup_date = models.DateTimeField(db_column='Act_Followup_Date', blank=True,
                                             null=True)  # Field name made lowercase.
    source = models.CharField(db_column='Source', max_length=20, blank=True, null=True)  # Field name made lowercase.
    win_probability = models.IntegerField(db_column='Win_Probability', blank=True,
                                          null=True)  # Field name made lowercase.
...
class RawStockOld(TruncatedModel):
    ...
    distance_across = models.FloatField(db_column='Distance_Across', blank=True,
                                        null=True)  # Field name made lowercase.
    purchase_unit_weight = models.FloatField(db_column='Purchase_Unit_Weight', blank=True,
                                             null=True)  # Field name made lowercase.
...
class RawStockWeight(TruncatedModel):
    ...
    last_updated = models.DateTimeField(db_column='Last_Updated')  # Field name made lowercase.
    tfm_alloy = models.CharField(db_column='TFM_Alloy', max_length=50, blank=True,
                                 null=True)  # Field name made lowercase.
...
class Receipt(TruncatedModel):
    ...
    bank = models.CharField(db_column='Bank', max_length=15, blank=True, null=True)  # Field name made lowercase.
    ar_code = models.CharField(db_column='AR_Code', max_length=15, blank=True, null=True)  # Field name made lowercase.
    reference = models.CharField(db_column='Reference', max_length=8, blank=True,
                                 null=True)  # Field name made lowercase.
    ...
    customer_receipt = models.CharField(db_column='Customer_Receipt', max_length=50, blank=True,
                                        null=True)  # Field name made lowercase.
    note_text = models.TextField(db_column='Note_Text', blank=True,
                                 null=True)  # Field name made lowercase. This field type is a guess.
...
class ReceiptDistribution(TruncatedModel):
    receipt_distribution = models.CharField(db_column='Receipt_Distribution', primary_key=True,
                                            max_length=50)  # Field name made lowercase.
...
class Report(TruncatedModel):
    reportidkey = models.AutoField(db_column='ReportIDKey', primary_key=True)  # Field name made lowercase.
    reportid = models.IntegerField(db_column='ReportID', unique=True, blank=True,
                                   null=True)  # Field name made lowercase.
    ...
    description = models.CharField(db_column='Description', max_length=254, blank=True,
                                   null=True)  # Field name made lowercase.
    description2 = models.CharField(db_column='Description2', max_length=254, blank=True,
                                    null=True)  # Field name made lowercase.
    ...
    databasecaption2 = models.CharField(db_column='DatabaseCaption2', max_length=254, blank=True,
                                        null=True)  # Field name made lowercase.
    accessddemacro = models.CharField(db_column='AccessDDEMacro', max_length=254, blank=True,
                                      null=True)  # Field name made lowercase.
    accessddeservice = models.CharField(db_column='AccessDDEService', max_length=254, blank=True,
                                        null=True)  # Field name made lowercase.
    accessddetopic = models.CharField(db_column='AccessDDETopic', max_length=254, blank=True,
                                      null=True)  # Field name made lowercase.
    ...
    application = models.CharField(db_column='Application', max_length=254, blank=True,
                                   null=True)  # Field name made lowercase.
    commandlineargs = models.CharField(db_column='CommandLineArgs', max_length=254, blank=True,
                                       null=True)  # Field name made lowercase.
    usedde = models.BooleanField(db_column='UseDDE')  # Field name made lowercase.
    ddemacro = models.CharField(db_column='DDEMacro', max_length=254, blank=True,
                                null=True)  # Field name made lowercase.
    ddeservice = models.CharField(db_column='DDEService', max_length=254, blank=True,
                                  null=True)  # Field name made lowercase.
    ddetopic = models.CharField(db_column='DDETopic', max_length=50, blank=True,
                                null=True)  # Field name made lowercase.
...
class SoDetail(TruncatedModel):
    so_detailkey = models.AutoField(db_column='SO_DetailKey', primary_key=True)  # Field name made lowercase.
    so_detail = models.IntegerField(db_column='SO_Detail', unique=True, blank=True,
                                    null=True)  # Field name made lowercase.
    sales_order = models.ForeignKey('SoHeader', models.DO_NOTHING,
                                    db_column='Sales_Order')  # Field name made lowercase.
    ...
    price_uofm = models.CharField(db_column='Price_UofM', max_length=4)  # Field name made lowercase.
    total_price = models.DecimalField(db_column='Total_Price', max_digits=19,
                                      decimal_places=4)  # Field name made lowercase.
    deferred_qty = models.FloatField(db_column='Deferred_Qty')  # Field name made lowercase.
    prepaid_amt = models.DecimalField(db_column='Prepaid_Amt', max_digits=19,
                                      decimal_places=4)  # Field name made lowercase.
...
class SoHeader(AutoNumberMixin, TruncatedModel):
    auto_number_attrs = [AutoNumberColumn('sales_order', 'SalesOrder')]

    sales_order = models.CharField(db_column='Sales_Order', primary_key=True,
                                   max_length=10)  # Field name made lowercase.
    ...
    sales_rep = models.CharField(db_column='Sales_Rep', max_length=6, blank=True,
                                 null=True)  # Field name made lowercase.
    order_taken_by = models.CharField(db_column='Order_Taken_By', max_length=6, blank=True,
                                      null=True)  # Field name made lowercase.
    ship_via = models.CharField(db_column='Ship_Via', max_length=15, blank=True, null=True)  # Shipment Method
    tax_code = models.CharField(db_column='Tax_Code', max_length=15, blank=True,
                                null=True)  # Field name made lowercase.
    terms = models.CharField(db_column='Terms', max_length=15, blank=True, null=True)  # Field name made lowercase.
    sales_tax_amt = models.DecimalField(db_column='Sales_Tax_Amt', max_digits=19,
                                        decimal_places=4)  # Field name made lowercase.
...
class SchedBillDist(TruncatedModel):
    sched_bill_dist = models.CharField(db_column='Sched_Bill_Dist', primary_key=True,
                                       max_length=50)  # Field name made lowercase.
    scheduled_bill = models.CharField(db_column='Scheduled_Bill', max_length=50, blank=True,
                                      null=True)  # Field name made lowercase.
    amount = models.FloatField(db_column='Amount')  # Field name made lowercase.
    description = models.CharField(db_column='Description', max_length=30, blank=True,
                                   null=True)  # Field name made lowercase.
...
class ScheduledBill(TruncatedModel):
    scheduled_bill = models.CharField(db_column='Scheduled_Bill', primary_key=True,
                                      max_length=50)  # Field name made lowercase.
    ...
    base_number = models.CharField(db_column='Base_Number', max_length=20, blank=True,
                                   null=True)  # Field name made lowercase.
...
class Serialnumber(TruncatedModel):
    objectid = models.CharField(db_column='ObjectID', primary_key=True, max_length=36)  # Field name made lowercase.
    serialnumber = models.CharField(db_column='SerialNumber', max_length=25, blank=True,
                                    null=True)  # Field name made lowercase.
    partnumber = models.CharField(db_column='PartNumber', max_length=30, blank=True,
                                  null=True)  # Field name made lowercase.
...
class Serialnumberdetail(TruncatedModel):
    objectid = models.CharField(db_column='ObjectID', primary_key=True, max_length=36)  # Field name made lowercase.
    serialnumber_oid = models.CharField(db_column='SerialNumber_OID', max_length=36, blank=True,
                                        null=True)  # Field name made lowercase.
    reference_oid = models.CharField(db_column='Reference_OID', max_length=36, blank=True,
                                     null=True)  # Field name made lowercase.
    ownerreference_oid = models.CharField(db_column='OwnerReference_OID', max_length=36, blank=True,
                                          null=True)  # Field name made lowercase.
...
class Service(TruncatedModel):
    ...
    description = models.CharField(db_column='Description', max_length=25, blank=True,
                                   null=True)  # Field name made lowercase.
    minimum_chg = models.DecimalField(db_column='Minimum_Chg', max_digits=19,
                                      decimal_places=4)  # Field name made lowercase.
    lead_days = models.SmallIntegerField(db_column='Lead_Days')  # Field name made lowercase.
    note_text = models.TextField(db_column='Note_Text', blank=True,
                                 null=True)  # Field name made lowercase. This field type is a guess.
...
class ShapeDimension(TruncatedModel):
    shape_dimension = models.CharField(db_column='Shape_Dimension', primary_key=True,
                                       max_length=50)  # Field name made lowercase.
    shape = models.CharField(db_column='Shape', max_length=50, blank=True, null=True)  # Field name made lowercase.
    dimension = models.CharField(db_column='Dimension', max_length=50, blank=True,
                                 null=True)  # Field name made lowercase.
    db_field_name = models.CharField(db_column='DB_Field_Name', max_length=50, blank=True,
                                     null=True)  # Field name made lowercase.
    display_name = models.CharField(db_column='Display_Name', max_length=50, blank=True,
                                    null=True)  # Field name made lowercase.
    last_updated = models.DateTimeField(db_column='Last_Updated', blank=True, null=True)  # Field name made lowercase.
...
class Source(TruncatedModel):
    ...
    last_recv_date = models.DateTimeField(db_column='Last_Recv_Date', blank=True,
                                          null=True)  # Field name made lowercase.
    last_updated = models.DateTimeField(db_column='Last_Updated')  # Field name made lowercase.
    holder_id = models.CharField(db_column='Holder_ID', max_length=50, blank=True,
                                 null=True)  # Field name made lowercase.
    total_tax_assigned = models.FloatField(db_column='Total_Tax_Assigned', blank=True,
                                           null=True)  # Field name made lowercase.
    source_type = models.IntegerField(db_column='Source_Type', blank=True, null=True)  # Field name made lowercase.
    po_type = models.IntegerField(db_column='PO_Type', blank=True, null=True)  # Field name made lowercase.
    quote_operation_qty = models.IntegerField(db_column='Quote_Operation_Qty', blank=True,
                                              null=True)  # Field name made lowercase.
    ...
    due_date = models.DateTimeField(db_column='Due_Date', blank=True, null=True)  # Field name made lowercase.
    objectid = models.CharField(db_column='ObjectID', unique=True, max_length=36)  # Field name made lowercase.
    po_detail_oid = models.CharField(db_column='PO_Detail_OID', max_length=36, blank=True,
                                     null=True)  # Field name made lowercase.
    material_req_oid = models.CharField(db_column='Material_Req_OID', max_length=36, blank=True,
                                        null=True)  # Field name made lowercase.
    job_operation_oid = models.CharField(db_column='Job_Operation_OID', max_length=36, blank=True,
...
class StatusChange(TruncatedModel):
...
class StatusDefinitions(TruncatedModel):
    status_definitionskey = models.AutoField(db_column='Status_DefinitionsKey',
                                             primary_key=True)  # Field name made lowercase.
    status_definitions = models.IntegerField(db_column='Status_Definitions', blank=True,
                                             null=True)  # Field name made lowercase.
    status_class = models.CharField(db_column='Status_Class', max_length=30, blank=True,
                                    null=True)  # Field name made lowercase.
    display_name = models.CharField(db_column='Display_Name', max_length=10, blank=True,
                                    null=True)  # Field name made lowercase.
    last_updated = models.DateTimeField(db_column='Last_Updated')  # Field name made lowercase.
...
class StockItem(TruncatedModel):
    stock_item = models.CharField(db_column='Stock_Item', primary_key=True, max_length=50)  # Field name made lowercase.
    name = models.CharField(db_column='Name', max_length=30, blank=True, null=True)  # Field name made lowercase.
    primary_vendor = models.CharField(db_column='Primary_Vendor', max_length=10, blank=True,
                                      null=True)  # Field name made lowercase.
    ...
    sales_code = models.CharField(db_column='Sales_Code', max_length=15, blank=True,
                                  null=True)  # Field name made lowercase.
    pick_buy_indicator = models.CharField(db_column='Pick_Buy_Indicator', max_length=1, blank=True,
                                          null=True)  # Field name made lowercase.
    class_field = models.CharField(db_column='Class', max_length=10, blank=True,
                                   null=True)  # Field name made lowercase. Field renamed because it was a Python reserved word.
    stocked_uofm = models.CharField(db_column='Stocked_UofM', max_length=4, blank=True,
                                    null=True)  # Field name made lowercase.
    purchase_uofm = models.CharField(db_column='Purchase_UofM', max_length=4, blank=True,
                                     null=True)  # Field name made lowercase.
    cost_uofm = models.CharField(db_column='Cost_UofM', max_length=4, blank=True,
                                 null=True)  # Field name made lowercase.
    ...
    pounds_per_base_unit = models.FloatField(db_column='Pounds_Per_Base_Unit', blank=True,
                                             null=True)  # Field name made lowercase.
...
class TaxCodeDetail(TruncatedModel):
    tax_code_detail = models.CharField(db_column='Tax_Code_Detail', primary_key=True,
                                       max_length=50)  # Field name made lowercase.
    tax_code = models.CharField(db_column='Tax_Code', max_length=50, blank=True,
                                null=True)  # Field name made lowercase.
...
class TaxDetail(TruncatedModel):
...
class Taxer(TruncatedModel):
    taxer = models.CharField(db_column='Taxer', primary_key=True, max_length=50)  # Field name made lowercase.
    name = models.CharField(db_column='Name', max_length=50, blank=True, null=True)  # Field name made lowercase.
    collection_account = models.CharField(db_column='Collection_Account', max_length=100, blank=True,
                                          null=True)  # Field name made lowercase.
    paid_account = models.CharField(db_column='Paid_Account', max_length=100, blank=True,
                                    null=True)  # Field name made lowercase.
...
class ThirdPartyIntegration(TruncatedModel):
...
class TransactionData(TruncatedModel):
    transaction_data = models.CharField(db_column='Transaction_Data', primary_key=True,
                                        max_length=50)  # Field name made lowercase.
    transaction_type = models.IntegerField(db_column='Transaction_Type', blank=True,
                                           null=True)  # Field name made lowercase.
    ...
    terminal_id = models.CharField(db_column='Terminal_ID', max_length=50, blank=True,
                                   null=True)  # Field name made lowercase.
    status = models.IntegerField(db_column='Status', blank=True, null=True)  # Field name made lowercase.
    transaction_start = models.DateTimeField(db_column='Transaction_Start', blank=True,
                                             null=True)  # Field name made lowercase.
    transaction_end = models.DateTimeField(db_column='Transaction_End', blank=True,
                                           null=True)  # Field name made lowercase.
    error_id = models.CharField(db_column='Error_ID', max_length=50, blank=True,
                                null=True)  # Field name made lowercase.
    error_text = models.CharField(db_column='Error_Text', max_length=255, blank=True,
                                  null=True)  # Field name made lowercase.
    linked_tran_int = models.IntegerField(db_column='Linked_Tran_Int', blank=True,
                                          null=True)  # Field name made lowercase.
    linked_tran_string = models.CharField(db_column='Linked_Tran_String', max_length=50, blank=True,
                                          null=True)  # Field name made lowercase.
    target_int = models.IntegerField(db_column='Target_Int', blank=True, null=True)  # Field name made lowercase.
    target_string = models.CharField(db_column='Target_String', max_length=50, blank=True,
                                     null=True)  # Field name made lowercase.
    job = models.CharField(db_column='Job', max_length=10, blank=True, null=True)  # Field name made lowercase.
    material = models.CharField(db_column='Material', max_length=30, blank=True,
                                null=True)  # Field name made lowercase.
    ...
    location = models.CharField(db_column='Location', max_length=10, blank=True,
                                null=True)  # Field name made lowercase.
    location_1 = models.CharField(db_column='Location_1', max_length=10, blank=True,
                                  null=True)  # Field name made lowercase.
    lot = models.CharField(db_column='Lot', max_length=20, blank=True, null=True)  # Field name made lowercase.
...
class TransactionDefinition(TruncatedModel):
    id = models.IntegerField(db_column='ID', primary_key=True)  # Field name made lowercase.
    prompt_display = models.CharField(db_column='Prompt_Display', max_length=30, blank=True,
                                      null=True)  # Field name made lowercase.
...
class TransactionDetail(TruncatedModel):
    transaction_detail = models.AutoField(db_column='Transaction_Detail',
                                          primary_key=True)  # Field name made lowercase.
    transaction_data = models.CharField(db_column='Transaction_Data', max_length=50, blank=True,
                                        null=True)  # Field name made lowercase.
    target_integer = models.IntegerField(db_column='Target_Integer', blank=True,
                                         null=True)  # Field name made lowercase.
    ...
    percent_complete = models.FloatField(db_column='Percent_Complete', blank=True,
                                         null=True)  # Field name made lowercase.
    ...
    rework_rsn = models.CharField(db_column='Rework_Rsn', max_length=15, blank=True,
                                  null=True)  # Field name made lowercase.
    scrap_rsn = models.CharField(db_column='Scrap_Rsn', max_length=15, blank=True,
                                 null=True)  # Field name made lowercase.
    ...
    work_center = models.CharField(db_column='Work_Center', max_length=10, blank=True,
                                   null=True)  # Field name made lowercase.
    job = models.CharField(db_column='Job', max_length=10, blank=True, null=True)  # Field name made lowercase.
    operation = models.CharField(db_column='Operation', max_length=10, blank=True,
                                 null=True)  # Field name made lowercase.
    linked_tran_string = models.CharField(db_column='Linked_Tran_String', max_length=50, blank=True,
                                          null=True)  # Field name made lowercase.
...
class TransactionSetting(TruncatedModel):
    transaction_setting = models.CharField(db_column='Transaction_Setting', primary_key=True,
                                           max_length=50)  # Field name made lowercase.
    transaction_value = models.CharField(db_column='Transaction_Value', max_length=50, blank=True,
                                         null=True)  # Field name made lowercase.
    employee = models.CharField(db_column='Employee', max_length=6, blank=True, null=True)  # Field name made lowercase.
    permission = models.CharField(db_column='Permission', max_length=50, blank=True,
                                  null=True)  # Field name made lowercase.
    default_value = models.CharField(db_column='Default_Value', max_length=50, blank=True,
                                     null=True)  # Field name made lowercase.
    display_text = models.CharField(db_column='Display_Text', max_length=20, blank=True,
                                    null=True)  # Field name made lowercase.
...
class TransactionValue(TruncatedModel):
    transaction_value = models.CharField(db_column='Transaction_Value', primary_key=True,
                                         max_length=50)  # Field name made lowercase.
    ...
    last_updated = models.DateTimeField(db_column='Last_Updated', blank=True, null=True)  # Field name made lowercase.
    transaction_definition = models.IntegerField(db_column='Transaction_Definition', blank=True,
                                                 null=True)  # Field name made lowercase.
    ...
    transaction_field = models.CharField(db_column='Transaction_Field', max_length=50, blank=True,
                                         null=True)  # Field name made lowercase.
...
class UserLabels(TruncatedModel):
    ...
    date1_label = models.CharField(db_column='Date1_Label', max_length=12, blank=True,
                                   null=True)  # Field name made lowercase.
    date2_label = models.CharField(db_column='Date2_Label', max_length=12, blank=True,
                                   null=True)  # Field name made lowercase.
    text1_label = models.CharField(db_column='Text1_Label', max_length=12, blank=True,
                                   null=True)  # Field name made lowercase.
    text2_label = models.CharField(db_column='Text2_Label', max_length=12, blank=True,
                                   null=True)  # Field name made lowercase.
    text3_label = models.CharField(db_column='Text3_Label', max_length=12, blank=True,
                                   null=True)  # Field name made lowercase.
    text4_label = models.CharField(db_column='Text4_Label', max_length=12, blank=True,
                                   null=True)  # Field name made lowercase.
    text5_label = models.CharField(db_column='Text5_Label', max_length=12, blank=True,
                                   null=True)  # Field name made lowercase.
    amount1_label = models.CharField(db_column='Amount1_Label', max_length=12, blank=True,
                                     null=True)  # Field name made lowercase.
    amount2_label = models.CharField(db_column='Amount2_Label', max_length=12, blank=True,
                                     null=True)  # Field name made lowercase.
    numeric1_label = models.CharField(db_column='Numeric1_Label', max_length=12, blank=True,
                                      null=True)  # Field name made lowercase.
    numeric2_label = models.CharField(db_column='Numeric2_Label', max_length=12, blank=True,
                                      null=True)  # Field name made lowercase.
    decimal1_label = models.CharField(db_column='Decimal1_Label', max_length=12, blank=True,
                                      null=True)  # Field name made lowercase.
    last_updated = models.DateTimeField(db_column='Last_Updated', blank=True, null=True)  # Field name made lowercase.
    objectid = models.CharField(db_column='ObjectID', unique=True, max_length=36)  # Field name made lowercase.
...
class UserValues(TruncatedModel):
    user_valueskey = models.AutoField(db_column='User_ValuesKey', primary_key=True)  # Field name made lowercase.
    user_values = models.IntegerField(db_column='User_Values', unique=True, blank=True,
                                      null=True)  # Field name made lowercase.
    date1 = models.DateTimeField(db_column='Date1', blank=True, null=True)  # Field name made lowercase.
    ...
    amount1 = models.DecimalField(db_column='Amount1', max_digits=19, decimal_places=4, blank=True,
                                  null=True)  # Field name made lowercase.
    amount2 = models.DecimalField(db_column='Amount2', max_digits=19, decimal_places=4, blank=True,
                                  null=True)  # Field name made lowercase.
    numeric1 = models.FloatField(db_column='Numeric1', blank=True, null=True)  # Field name made lowercase.
    numeric2 = models.FloatField(db_column='Numeric2', blank=True, null=True)  # Field name made lowercase.
...
class Vendor(TruncatedModel):
    ...
    our_account_id = models.CharField(db_column='Our_Account_ID', max_length=25, blank=True,
                                      null=True)  # Field name made lowercase.
    lead_days = models.SmallIntegerField(db_column='Lead_Days', blank=True, null=True)  # Field name made lowercase.
...
class VendorMaterial(TruncatedModel):
    vendor_material = models.CharField(db_column='Vendor_Material', primary_key=True,
                                       max_length=50)  # Field name made lowercase.
    vendor = models.CharField(db_column='Vendor', max_length=10, blank=True, null=True)  # Field name made lowercase.
    material_owner = models.CharField(db_column='Material_Owner', max_length=50, blank=True,
                                      null=True)  # Field name made lowercase.
    vendor_reference = models.CharField(db_column='Vendor_Reference', max_length=30, blank=True,
                                        null=True)  # Field name made lowercase.
...
class VendorService(TruncatedModel):
    ...
    vendor_service = models.IntegerField(db_column='Vendor_Service', blank=True,
                                         null=True)  # Field name made lowercase.
...
class WcdisplaySequence(TruncatedModel):
    objectid = models.CharField(db_column='ObjectID', primary_key=True, max_length=36)  # Field name made lowercase.
...
class Wcemployee(TruncatedModel):
    objectid = models.CharField(db_column='ObjectID', primary_key=True, max_length=36)  # Field name made lowercase.
    workcenter_oid = models.CharField(db_column='WorkCenter_OID', max_length=36, blank=True,
                                      null=True)  # Field name made lowercase.
    employee_oid = models.CharField(db_column='Employee_OID', max_length=36, blank=True,
...
class Wcmaterialclass(TruncatedModel):
    objectid = models.CharField(db_column='ObjectID', primary_key=True, max_length=36)  # Field name made lowercase.
    workcenter_oid = models.CharField(db_column='WorkCenter_OID', max_length=36, blank=True,
                                      null=True)  # Field name made lowercase.
    class_oid = models.CharField(db_column='Class_OID', max_length=36, blank=True,
                                 null=True)  # Field name made lowercase.
    last_updated = models.DateTimeField(db_column='Last_Updated', blank=True, null=True)  # Field name made lowercase.
...
class Wcmaterialshape(TruncatedModel):
    objectid = models.CharField(db_column='ObjectID', primary_key=True, max_length=36)  # Field name made lowercase.
    workcenter_oid = models.CharField(db_column='WorkCenter_OID', max_length=36, blank=True,
                                      null=True)  # Field name made lowercase.
    shape_oid = models.CharField(db_column='Shape_OID', max_length=36, blank=True,
...
class WcshiftOverride(TruncatedModel):
    objectid = models.CharField(db_column='ObjectID', primary_key=True, max_length=36)  # Field name made lowercase.
    shift_id = models.CharField(db_column='Shift_ID', max_length=36, blank=True,
                                null=True)  # Field name made lowercase.
    ...
    operators_per_machine = models.FloatField(db_column='Operators_Per_Machine', blank=True,
                                              null=True)  # Field name made lowercase.
...
class WcshiftStandard(TruncatedModel):
    objectid = models.CharField(db_column='ObjectID', primary_key=True, max_length=36)  # Field name made lowercase.
    shift_id = models.CharField(db_column='Shift_ID', max_length=36, blank=True,
                                null=True)  # Field name made lowercase.
    machines = models.IntegerField(db_column='Machines', blank=True, null=True)  # Field name made lowercase.
...
class WorkcenterLoad(TruncatedModel):
    objectid = models.CharField(db_column='ObjectID', primary_key=True, max_length=36)  # Field name made lowercase.
    start_date = models.DateTimeField(db_column='Start_Date', blank=True, null=True)  # Field name made lowercase.
    end_date = models.DateTimeField(db_column='End_Date', blank=True, null=True)  # Field name made lowercase.
    workcenter_oid = models.CharField(db_column='WorkCenter_OID', max_length=36, blank=True,
...
class WorkCenter(TruncatedModel):
    work_center = models.CharField(db_column='Work_Center', primary_key=True,
                                   max_length=10)  # Field name made lowercase.
    user_values_old = models.IntegerField(db_column='User_Values_OLD', blank=True,
                                          null=True)  # Field name made lowercase.
    department = models.CharField(db_column='Department', max_length=15, blank=True,
                                  null=True)  # Field name made lowercase.
    type = models.CharField(db_column='Type', max_length=8)  # Field name made lowercase.
    setup_labor_rate = models.DecimalField(db_column='Setup_Labor_Rate', max_digits=19, decimal_places=4, blank=True,
                                           null=True)  # Field name made lowercase.
    run_labor_rate = models.DecimalField(db_column='Run_Labor_Rate', max_digits=19, decimal_places=4, blank=True,
                                         null=True)  # Field name made lowercase.
    labor_burden = models.FloatField(db_column='Labor_Burden', blank=True, null=True)  # Field name made lowercase.
    machine_burden = models.DecimalField(db_column='Machine_Burden', max_digits=19, decimal_places=4, blank=True,
                                         null=True)  # Field name made lowercase.
    ...
    queue_hrs = models.FloatField(db_column='Queue_Hrs', blank=True, null=True)  # Field name made lowercase.
    nbr_limiting_rsrc_old = models.SmallIntegerField(db_column='Nbr_Limiting_Rsrc_OLD', blank=True,
                                                     null=True)  # Field name made lowercase.
    ...
    parent_id = models.CharField(db_column='Parent_ID', max_length=10, blank=True,
                                 null=True)  # Field name made lowercase.
    objectid = models.CharField(db_column='ObjectID', unique=True, max_length=36)  # Field name made lowercase.
    machines = models.IntegerField(db_column='Machines', blank=True, null=True)  # Field name made lowercase.
    operators = models.IntegerField(db_column='Operators', blank=True, null=True)  # Field name made lowercase.
    operators_per_machine = models.FloatField(db_column='Operators_Per_Machine', blank=True,
                                              null=True)  # Field name made lowercase.
    parent_oid = models.CharField(db_column='Parent_OID', max_length=36, blank=True,
                                  null=True)  # Field name made lowercase.
    ...
    uvamount1 = models.DecimalField(db_column='UVAmount1', max_digits=19, decimal_places=4, blank=True,
                                    null=True)  # Field name made lowercase.
    uvamount2 = models.DecimalField(db_column='UVAmount2', max_digits=19, decimal_places=4, blank=True,
                                    null=True)  # Field name made lowercase.
    ...
    uvnote_text = models.TextField(db_column='UVNote_Text', blank=True,
                                   null=True)  # Field name made lowercase. This field type is a guess.
